...
- [**speedcubedb.com**](https://speedcubedb.com/) —— `/algdb` 公式库的数据来源（2x2/3x3/4x4/5x5 公式集 — F2L、OLL、PLL、COLL、ZBLL、1LLL、OLLCP、VLS、Parity、L2E、L2C 等；通过 `scramble-stats-build/bin/scrape_speedcubedb.ts` 抓取）
- [**speedsolving.com/wiki: Pretty Pattern**](https://www.speedsolving.com/wiki/index.php/Pretty_pattern) 与 [**ruwix.com Rubik's Cube Patterns**](https://ruwix.com/the-rubiks-cube/rubiks-cube-patterns-algorithms/) —— `/patterns` 图案集的公式来源
