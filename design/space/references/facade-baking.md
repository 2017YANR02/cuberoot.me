...
| `hsbc-detail-triangles-01` | 1024²、128 samples、EXTEND 8 px，显式三角化 12,792 个面后烘焙，保留投影 | 67.45 秒；EXR 3,483,485 字节，实际网页近景黑纹仍在。面角法线最大分量差约 0.000301，未构成严格单变量对照；恢复源几何后退出，未用于正式模型 |
