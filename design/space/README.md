...
当前上海版本（2026-09-13）：环球金融中心 100F 玻璃下方封板新增独立遮蔽贴图，区分夹层内侧与外露底面，保留原几何、表面 UV、浅色饰面和六组灯。源工程已保存，正式 GLB 为 **401,267,636 字节**、16 张共享纹理；两轮烘焙诊断、斜向射线、Three.js 加载器与模型/纹理 HTTP 校验见[最新跟踪记录](../../docs/space-blender-tracker.md#2026-09-13-100f-玻璃下方封板遮蔽)。本轮安全无头浏览器无法启用 WebGL，最终日夜画面尚未复查，不能认定亮条已消除。结构、材质和灯光仍有估算，尚未达到 1:1 或电影级。下方日期段落保留历史状态。重资产继续本地保存，Git LFS 配置与上传暂缓。
