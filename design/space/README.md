...
当前上海版本（2026-09-13）：金茂塔楼底部已加入细金属格栅、圆孔遮阳板、石材分缝、成对竖肋和圆形入口，第四候选完成近景检查并保存。正式 GLB 为 **596,609,688 字节**、16 张共享纹理；新增四个网格、裙房及周边共享网格、原塔楼 51 个网格的几何、材质和变换核对通过，加载器及完整 HTTP 下载校验见[最新跟踪记录](../../docs/space-blender-tracker.md#2026-09-13-金茂塔楼基部与圆形入口)。石材颗粒、雨棚拉杆、入口铺地、门厅与中庭内部和网页日夜画面继续待办；约 597 MB 整城资产尚需分区、LOD 和实际设备性能验证。尺寸及材质仍为照片估算，尚未达到 1:1 或电影级。下方日期段落保留历史状态。重资产继续本地保存，Git LFS 配置与上传暂缓。
