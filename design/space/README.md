...
当前上海版本（2026-09-13）：金茂幕墙、长塔身和上部退台细化后，参照 SOM 日夜实拍更新深蓝灰玻璃、银色金属与竖向亮线，完成同光照的日夜对照并保存。正式 GLB 为 **500,054,592 字节**、16 张共享纹理；金茂 51 个网格与候选的几何、材质和变换一致，Three.js 加载器与完整 HTTP 下载校验见[最新跟踪记录](../../docs/space-blender-tracker.md#2026-09-13-金茂玻璃金属与夜间亮线)。网页日夜画面尚未复查；尺寸及材质仍为照片估算，真实环境反射、塔冠配光、裙楼和内部空间需继续处理，尚未达到 1:1 或电影级。下方日期段落保留历史状态。重资产继续本地保存，Git LFS 配置与上传暂缓。
