...
当前上海版本（2026-09-13）：金茂裙房已替换旧体块，加入弧形高窗、水平百叶、入口雨棚、拱顶中庭和玻璃端墙，完成第六候选的六视角检查并保存。正式 GLB 为 **509,874,916 字节**、16 张共享纹理；新裙房、周边共享网格及原金茂 51 个网格的几何、材质和变换核对通过，加载器及完整 HTTP 下载校验见[最新跟踪记录](../../docs/space-blender-tracker.md#2026-09-13-金茂裙房入口与拱顶中庭)。塔楼底部、扶梯、连桥、室内灯具和网页日夜画面继续待办，尺寸及材质仍为照片估算，尚未达到 1:1 或电影级。下方日期段落保留历史状态。重资产继续本地保存，Git LFS 配置与上传暂缓。
