...
mod manager {
    ...
    fn ec_count(t: usize) -> u64 {
        ...
        match t {
            ...
            x if x == I::PsCrossC4 as usize
                ...
                || x == I::PsCrossC7 as usize =>
            {
                cr * cn
            }
            x if (I::PsCrossInsC4Diff0 as usize..=I::PsCrossInsC7Diff3 as usize).contains(&x) => {
                cr * cn
            }
    ...
    impl PruneTableManager {
        ...
        fn ensure_pspair_with(
            ...
            let expected_entries = (state_space::EDGE as u64) * (state_space::CORNER as u64);
    ...
    pt_ensure_release!(
        ensure_pt_cross_ins_c4,
        release_pt_cross_ins_c4,
        PtId::CrossInsC4,
        pc::gen_pt_cross_ins_c4
    );
    pt_ensure_release!(
        ensure_pt_pair_c4e0,
        release_pt_pair_c4e0,
        PtId::PairC4E0,
        pc::gen_pt_pair_c4e0
    );
    pt_ensure_release!(
        ensure_pt_cross_c4e0,
        release_pt_cross_c4e0,
        PtId::CrossC4E0,
        pc::gen_pt_cross_c4e0
    );
    pt_ensure_release!(
        ensure_pt_cross_c4c5e0e1,
        release_pt_cross_c4c5e0e1,
        PtId::CrossC4C5E0E1,
        pc::gen_pt_cross_c4c5e0e1
    );
    pt_ensure_release!(
        ensure_pt_cross_c4c6e0e2,
        release_pt_cross_c4c6e0e2,
        PtId::CrossC4C6E0E2,
        pc::gen_pt_cross_c4c6e0e2
    );
    ...
    pt_ensure_release!(
        ensure_pt_pscross_e0e1,
        release_pt_pscross_e0e1,
        PtId::PsCrossE0E1,
        pc::gen_pt_pscross_e0e1
    );
    pt_ensure_release!(
        ensure_pt_pscross_e0e2,
        release_pt_pscross_e0e2,
        PtId::PsCrossE0E2,
        pc::gen_pt_pscross_e0e2
    );
    pt_ensure_release!(
        ensure_pt_pscross_e0e1e2,
        release_pt_pscross_e0e1e2,
        PtId::PsCrossE0E1E2,
        pc::gen_pt_pscross_e0e1e2
    );
    pt_ensure_release!(
        ensure_pt_pscross_c4c5,
        release_pt_pscross_c4c5,
        PtId::PsCrossC4C5,
        pc::gen_pt_pscross_c4c5
    );
    pt_ensure_release!(
        ensure_pt_pscross_c4c6,
        release_pt_pscross_c4c6,
        PtId::PsCrossC4C6,
        pc::gen_pt_pscross_c4c6
    );
    pt_ensure_release!(
        ensure_pt_pscross_c4c5c6,
        release_pt_pscross_c4c5c6,
        PtId::PsCrossC4C5C6,
        pc::gen_pt_pscross_c4c5c6
    );
    ...
    pt_ensure_release!(
        ...
        release_pt_cross_c4e0e1,
        PtId::CrossC4E0E1,
        pc::gen_pt_cross_c4e0e1
    );
    pt_ensure_release!(
        ensure_pt_cross_c4e0e2,
        release_pt_cross_c4e0e2,
        PtId::CrossC4E0E2,
        pc::gen_pt_cross_c4e0e2
    );
    pt_ensure_release!(
        ensure_pt_cross_c4e0e3,
        release_pt_cross_c4e0e3,
        PtId::CrossC4E0E3,
        pc::gen_pt_cross_c4e0e3
    );
    pt_ensure_release!(
        ensure_pt_cross_c4c5e0,
        release_pt_cross_c4c5e0,
        PtId::CrossC4C5E0,
        pc::gen_pt_cross_c4c5e0
    );
    pt_ensure_release!(
        ensure_pt_cross_c4c6e0,
        release_pt_cross_c4c6e0,
        PtId::CrossC4C6E0,
        pc::gen_pt_cross_c4c6e0
    );
    pt_ensure_release!(
        ensure_pt_cross_c4c7e0,
        release_pt_cross_c4c7e0,
        PtId::CrossC4C7E0,
        pc::gen_pt_cross_c4c7e0
    );
    pt_ensure_release!(
        ensure_pt_cross_c4c5c6,
        release_pt_cross_c4c5c6,
        PtId::CrossC4C5C6,
        pc::gen_pt_cross_c4c5c6
    );
...
mod tests {
    ...
    fn pt_pscross_c4_gen() {
        with_table_dir("pt_pscross_c4", || {
            ...
            let solved_idx = state_space::CROSS_SOLVED as u64 * state_space::CORNER as u64 + 12;
    ...
    fn pt_cross_ins_c4_gen() {
        with_table_dir("pt_cross_ins_c4", || {
            ...
            assert_eq!(t.entry_count, n);
            assert_eq!(
                fs::metadata(table_path("pt_cross_ins_C4.bin"))
                    .unwrap()
                    .len(),
                PT_HEADER_BYTES as u64 + (n + 1) / 2
            );
    ...
    fn pt_cross_c4e0_gen() {
        with_table_dir("pt_cross_c4e0", || {
            ...
            let n =
                state_space::CROSS as u64 * state_space::CORNER as u64 * state_space::EDGE as u64;
            assert_eq!(t.entry_count, n);
            // SOLVED idx
            let cr = state_space::CROSS_SOLVED as u64;
            let cn = 12u64; // C4
            let ed = 0u64; // E0
            let solved = cr * (state_space::CORNER as u64) * (state_space::EDGE as u64)
    ...
    fn pt_huge_default_panics() {
        with_table_dir("pt_huge_protect", || {
            ...
            assert!(
                r.is_err(),
                "ensure_pt_cross_c4c5e0e1 should panic by default"
            );
        });
    }
    ...
    fn pt_cross_depth_sanity() {
        ...
        with_table_dir("pt_cross_depth", || {
            ...
            for &mv in &[9u32, 12, 0, 1] {
                ...
                assert!(
                    d <= 1,
                    "single-move depth should be ≤ 1 (move={}, d={})",
                    mv,
                    d
                );
            }
