...
- `build_recent_scrambles.ts` `VARIANTS` → 首页 RecentScrambles / 今日神打 纳入新变体
  (动首页数据形态,先问用户)。
...
| (参考)Roux S1 全表 | 5,322,240 | ~5MB | 预期同级(查表) | 未测 |
...
| Roux S1(1x2x3) | 2角+3棱(如 DBL+DFL 角 + DL,BL,FL 棱) | 504×10560=5.3M | ✅ 可全表 |
| EOLine | EO12 + DF,DB 两棱位置 | 2048×132=270K | ✅ |
| EOCross | EO12 + 十字 4 棱 | 2048×11880=24.3M | ✅(pt_ep4eo12 已有,eo 变体已覆盖) |
| Petrus 2x2x2+2x2x3 | 块 → 2角+4棱 | 253K → 504×(12P4·16)=… | ✅(两阶段 cascade) |
