...
截至 2026-08-19,教学系统已经统一到主站前端与 Core 教学 API:

- Stage 0 至 Stage 2 已覆盖多租户权限、校区 / 班级 / 学员关系、课包账本、排课、出勤与正常消课。
...
仍未完成的产品面包括支付接单、退款 / 撤销反向流水、请假补课规则、批量导入、远程搜索选择器和完整经营报表。源码完成不能替代生产部署与登录态验收。
