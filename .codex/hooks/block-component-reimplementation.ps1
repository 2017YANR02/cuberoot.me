...
if ($payload -notmatch '<button|<select|<X\b|<BackHome\b|<CaseThumb\b|multiOri|multi-ori|grid-template-columns|is-without-thumb|×|✕|关闭|close|clear|dismiss|EventIcon|CubingIcon|EventPicker|PuzzlePicker|PuzzleTypeSelect|eventPickerOpen|puzzlePickerOpen') { exit 0 }
