...
`);let n=/handled (\d+)%,/.exec(e);n&&S(parseInt(n[1],10)/100);let r=/^Solution found!:\s*(.+)$/i.exec(e);if(r){let e=r[1].trim().replace(/\s+/g,` `);M.current.push(e);return}let i=/^Cube(\d+)\s+finished\s+in\s/i.exec(e);if(i){let e=parseInt(i[1],10),t=M.current.shift();t!==void 0&&(F.current.set(e,t),P(new Map(F.current)))}return}if(t.code===-2){S(typeof t.data==`number`?t.data:-1);return}if(t.cmd===`select solver`)if(t.code===1)x(`no-solver`),y(null),q.current=null;else{let e={name:t.solver,table_name:t.table_name,table_size:Number(t.table_size)};y(e),q.current=e,x(t.code===0?`ready`:`need-init`)}else if(t.cmd===`generate table`)t.code===0&&(H.current=!0),x(t.code===0?`ready`:`need-init`),S(-1);else if(t.cmd===`upload table`)t.code===0?x(`ready`):(alert(n(`文件大小不匹配,请用对应 .dat`,`Wrong file size — use the matching .dat`)),x(`need-init`)),S(-1);else if(t.cmd===`start solve`)x(`ready`),S(-1);else if(t.cmd===`download table`){if(t.code===0){let e=new Blob([new Uint8Array(t.data)],{type:`application/octet-stream`}),n=URL.createObjectURL(e),r=document.createElement(`a`);r.href=n,r.download=q.current?.table_name||`cubeopt-table.dat`,r.click(),URL.revokeObjectURL(n)}x(`ready`)}}};(0,f.useEffect)(()=>{let e=new Worker(`/cubeopt/wasm-worker.js`);return W.current=e,Ie(e),()=>{e.terminate(),W.current=null}},[]);let Le=()=>{if(!W.current)return;W.current.terminate(),B.current=!1,H.current=!1,S(-1),w(e=>e+`[cancelled by user]
`);let e=new Worker(`/cubeopt/wasm-worker.js`);W.current=e,Ie(e),x(`busy`),e.postMessage({cmd:`select solver`,data:_})};(0,f.useEffect)(()=>{W.current&&(x(`busy`),w(``),S(-1),B.current=!1,W.current.postMessage({cmd:`select solver`,data:_}))},[_]),(0,f.useEffect)(()=>{k%A!==0&&j(1)},[k,A]),(0,f.useEffect)(()=>{K.current&&(K.current.scrollTop=K.current.scrollHeight)},[C]);let Re=()=>{b===`need-init`&&(x(`busy`),w(``),W.current?.postMessage({cmd:`generate table`}))},Q=()=>{b===`ready`&&(x(`busy`),W.current?.postMessage({cmd:`download table`}))},ze=()=>G.current?.click(),Be=e=>{let t=e.target.files?.[0];if(t){if(t.name!==v?.table_name){alert(n(`文件名应为 ${v?.table_name}`,`Expected ${v?.table_name}`)),e.target.value=``;return}x(`busy`),S(0),W.current?.postMessage({cmd:`upload table`,data:t}),e.target.value=``}},Ve=()=>{let e=T.split(`
`).map(e=>e.trim()).filter(e=>e.length>0).join(`
`);if(!e){alert(n(`打乱不能为空`,`No scrambles`));return}E(e),x(`busy`),w(``),F.current=new Map,P(new Map),M.current=[],W.current?.postMessage({cmd:`start solve`,scramble:e,n_threads:k,n_group:A,debug:1})},He=()=>{if(b===`ready`){Ve();return}if(b===`need-init`){if(!T.split(`
`).map(e=>e.trim()).filter(Boolean).join(`
`)){alert(n(`打乱不能为空`,`No scrambles`));return}B.current=!0,Re()}};(0,f.useEffect)(()=>{if(b===`ready`){if(H.current&&V){H.current=!1;let e=setTimeout(()=>Q(),0);return()=>clearTimeout(e)}H.current=!1,B.current&&(B.current=!1,Ve())}},[b]);let Ue=()=>{let e=[];for(let t=0;t<O;t++)e.push(ge(D));E(e.join(`
`))},We=()=>{E(T.split(`
...
`).map(e=>e.trim()).find(Boolean);if(!e)return null;try{return d(e),e}catch{return null}},[T]);return(0,p.jsxs)(`div`,{className:`cubeopt-page`,children:[(0,p.jsx)(`style`,{children:_e}),(0,p.jsxs)(`header`,{className:`cubeopt-header`,children:[(0,p.jsx)(`h1`,{children:n(`最优解 (cubeopt)`,`Optimal Solver (cubeopt)`)}),(0,p.jsx)(ee,{variant:`inline`})]}),(0,p.jsx)(`p`,{className:`cubeopt-lead`,children:n(`复刻 cs0x7f/cubeopt-wasm: 给定打乱(或状态),用 cube48opt 系列 wasm 求 HTM 最少步解。`,`A React port of cs0x7f/cubeopt-wasm. Given a scramble (or state), find the optimal HTM solution.`)}),!Ne&&(0,p.jsx)(`div`,{className:`cubeopt-warn`,children:n(`当前页面没有 SharedArrayBuffer/COI,wasm 多线程跑不起来。如果是首次访问,刷新页面让 service worker 注入 COOP/COEP。`,`SharedArrayBuffer / cross-origin isolation not active — multithreaded wasm wont run. On first visit, reload after the service worker installs.`)}),g&&(0,p.jsx)(`div`,{className:`cubeopt-info`,children:(0,p.jsx)(`span`,{children:n(`检测到手机端 — 已默认 cube48opt1 (30M)。手机 wasm 内存有限,opt2/3 视机型可能 OK,opt4 起容易 OOM 崩页;生成时长是桌面的 3-5 倍,期间不要切到后台。`,`Mobile detected — defaulted to cube48opt1 (30M). Mobile wasm memory is tight; opt2/3 may work on flagship phones, opt4+ likely OOM. Gen takes 3-5× longer than desktop; don't background the tab during gen.`)})}),I&&(0,p.jsxs)(`div`,{className:`cubeopt-info`,children:[Y&&(0,p.jsx)(te,{size:14,className:`spinning`}),(0,p.jsx)(`span`,{children:I}),Y&&(0,p.jsxs)(`button`,{className:`btn-cancel-sm`,onClick:Fe,children:[(0,p.jsx)(u,{size:12}),` `,n(`取消`,`Cancel`)]})]}),(0,p.jsxs)(`section`,{className:`cubeopt-card`,children:[(0,p.jsxs)(`div`,{className:`row`,children:[(0,p.jsx)(`span`,{className:`lbl`,children:`Solver`}),(0,p.jsx)(`select`,{className:`ctl`,value:_,disabled:b===`busy`,onChange:e=>ve(e.target.value),children:m.map(e=>(0,p.jsxs)(`option`,{value:e.value,children:[e.value,` (`,e.size,`)`]},e.value))}),(0,p.jsx)(`span`,{className:`size-badge`,children:m.find(e=>e.value===_)?.size})]}),(0,p.jsxs)(`div`,{className:`row`,children:[(0,p.jsx)(`span`,{className:`lbl`,children:n(`Prun 表`,`Prun Table`)}),(0,p.jsx)(`span`,{className:`table-name`,children:v?.table_name??n(`未就绪`,`Not Ready`)}),(0,p.jsxs)(`label`,{className:`auto-dl`,children:[(0,p.jsx)(`input`,{type:`checkbox`,checked:V,onChange:e=>je(e.target.checked)}),(0,p.jsx)(`span`,{children:n(`生成后自动下载`,`Auto-download after gen`)})]}),b===`need-init`&&(0,p.jsxs)(p.Fragment,{children:[(0,p.jsx)(`button`,{className:`btn`,onClick:Re,children:n(`生成表`,`Generate Table`)}),(0,p.jsxs)(`button`,{className:`btn`,onClick:ze,children:[(0,p.jsx)(re,{size:14}),` `,n(`上传表`,`Upload Table`)]})]}),b===`ready`&&(0,p.jsxs)(`button`,{className:`btn`,onClick:Q,children:[(0,p.jsx)(a,{size:14}),` `,n(`下载表`,`Download Table`)]}),b===`busy`&&(0,p.jsxs)(`span`,{className:`busy-marker`,children:[(0,p.jsx)(te,{size:14,className:`spinning`}),` `,n(`忙`,`busy`),`…`]}),(0,p.jsx)(`input`,{ref:G,type:`file`,style:{display:`none`},onChange:Be})]}),ye>=0&&(0,p.jsx)(`div`,{className:`progress`,children:(0,p.jsx)(`div`,{className:`progress-bar`,style:{width:`${Math.round(ye*100)}%`}})})]}),(0,p.jsxs)(`section`,{className:`cubeopt-card`,children:[(0,p.jsxs)(`div`,{className:`row paint-toggle-row`,children:[(0,p.jsx)(`span`,{className:`lbl`,children:n(`从状态`,`From state`)}),(0,p.jsx)(`button`,{className:`btn${R?` is-active`:``}`,onClick:()=>Ce(e=>!e),title:n(`画一个魔方状态,自动求出对应打乱`,`Paint a cube state, auto-derive a scramble`),children:R?n(`收起`,`Hide`):n(`展开填色`,`Open paint`)}),(0,p.jsx)(`span`,{className:`paint-hint`,children:n(`点击格子 → 上色 → "求 scramble" → 自动填到下面打乱框,再点 Solve 求最优。`,`Click stickers → paint → "Derive scramble" → fills the box below, then Solve for optimal.`)})]}),R&&(0,p.jsx)(`div`,{className:`paint-wrap`,children:(0,p.jsx)(pe,{facelet:we,onChange:Te,activeColor:Ee,onActiveColorChange:De,pixelSize:Oe,solveLabel:{zh:`求 scramble`,en:`Derive scramble`},onSolve:e=>{Y||Pe(e).catch(e=>{L(n(`从状态求解失败:${e.message}`,`Solve from state failed: ${e.message}`))})}})})]}),(0,p.jsxs)(`section`,{className:`cubeopt-card`,children:[(0,p.jsxs)(`div`,{className:`row`,children:[(0,p.jsx)(`span`,{className:`lbl`,children:n(`随机`,`Random`)}),(0,p.jsx)(`select`,{className:`ctl-sm`,value:D,onChange:e=>be(parseInt(e.target.value,10)),children:me.map(e=>(0,p.jsxs)(`option`,{value:e,children:[e,` `,n(`步`,`moves`)]},e))}),(0,p.jsx)(`select`,{className:`ctl-sm`,value:O,onChange:e=>xe(parseInt(e.target.value,10)),children:he.map(e=>(0,p.jsxs)(`option`,{value:e,children:[e,` `,n(`个`,`cubes`)]},e))}),(0,p.jsx)(`button`,{className:`btn`,onClick:Ue,children:n(`生成`,`Random`)}),(0,p.jsx)(`button`,{className:`btn-icon`,onClick:We,title:n(`每行反向`,`Invert each line`),children:(0,p.jsx)(c,{size:14})}),(0,p.jsx)(`button`,{className:`btn-icon${z?` is-active`:``}`,onClick:()=>Ae(e=>!e),title:n(`打乱图预览(显示第一行打乱产生的状态)`,`Show preview of the first scramble`),children:z?(0,p.jsx)(s,{size:14}):(0,p.jsx)(o,{size:14})}),(0,p.jsx)(`button`,{className:`btn-icon`,onClick:()=>E(``),title:`Clear`,children:(0,p.jsx)(l,{size:14})})]}),(0,p.jsx)(`textarea`,{className:`scramble-area`,rows:5,placeholder:`R U R' U' R' F R2 U' R' U' R U R' F'`,value:T,onChange:e=>E(e.target.value)}),z&&$&&(0,p.jsxs)(`div`,{className:`scramble-preview`,children:[(0,p.jsx)(ne,{event:`333`,scramble:$,visualization:`2D`,size:28,className:`scramble-preview-svg`}),(0,p.jsx)(`span`,{className:`scramble-preview-label`,children:n(`应用第一行打乱后的状态`,`State after the first scramble`)})]}),(0,p.jsxs)(`div`,{className:`row`,children:[(0,p.jsx)(`span`,{className:`lbl`,children:n(`线程`,`Threads`)}),(0,p.jsx)(`select`,{className:`ctl-sm`,value:k,onChange:e=>Se(parseInt(e.target.value,10)),children:Array.from({length:navigator.hardwareConcurrency||4},(e,t)=>t+1).map(e=>(0,p.jsx)(`option`,{value:e,children:e},e))}),(0,p.jsx)(`span`,{className:`lbl`,children:n(`并发块`,`Concurrent`)}),(0,p.jsx)(`select`,{className:`ctl-sm`,value:A,onChange:e=>j(parseInt(e.target.value,10)),children:Ge.map(e=>(0,p.jsx)(`option`,{value:e,children:e},e))}),b===`busy`?(0,p.jsxs)(`button`,{className:`btn-cancel`,onClick:Le,title:n(`终止当前任务。会重建 wasm,prun 表会丢失需重新生成或上传。`,`Abort current task. Wasm will be reset; prun table is lost and must be re-generated or uploaded.`),children:[(0,p.jsx)(u,{size:14}),` `,n(`取消`,`Cancel`)]}):(0,p.jsx)(`button`,{className:`btn-primary`,disabled:b===`no-solver`||!Ke,onClick:He,title:b===`need-init`?n(`会先自动生成 prun 表(几十秒)再求解`,`Will auto-generate the prun table (tens of seconds) then solve`):void 0,children:b===`need-init`?(0,p.jsxs)(p.Fragment,{children:[(0,p.jsx)(c,{size:14}),` `,n(`生成表+求解`,`Gen Table + Solve`)]}):(0,p.jsx)(p.Fragment,{children:`Solve`})})]})]}),N.size>0&&(0,p.jsxs)(`section`,{className:`cubeopt-card`,children:[(0,p.jsxs)(`div`,{className:`row`,children:[(0,p.jsx)(`span`,{className:`lbl`,children:n(`解 (按输入顺序)`,`Solutions (input order)`)}),(0,p.jsx)(`span`,{className:`paint-hint`,children:n(`cubeopt 是按完成顺序输出的;此处按输入序号 1..N 排好,并标注步数。`,`cubeopt outputs in finish order; this panel re-sorts by input index 1..N with move counts.`)}),(0,p.jsx)(`button`,{className:`btn-icon`,onClick:()=>{let e=Array.from(N.entries()).sort((e,t)=>e[0]-t[0]).map(([e,t])=>`${e}. ${t}`).join(`
