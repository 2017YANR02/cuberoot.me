...
`).map(e=>e.trim()).find(Boolean);if(!e)return null;try{return f(e),e}catch{return null}},[E]);return(0,m.jsxs)(`div`,{className:`cubeopt-page`,children:[(0,m.jsx)(`style`,{children:ge}),(0,m.jsxs)(`header`,{className:`cubeopt-header`,children:[(0,m.jsx)(`h1`,{children:n(`最优解 (cubeopt)`,`Optimal Solver (cubeopt)`)}),(0,m.jsx)(ee,{variant:`inline`})]}),(0,m.jsx)(`p`,{className:`cubeopt-lead`,children:n(`复刻 cs0x7f/cubeopt-wasm: 给定打乱(或状态),用 cube48opt 系列 wasm 求 HTM 最少步解。`,`A React port of cs0x7f/cubeopt-wasm. Given a scramble (or state), find the optimal HTM solution.`)}),!Oe&&(0,m.jsx)(`div`,{className:`cubeopt-warn`,children:n(`当前页面没有 SharedArrayBuffer/COI,wasm 多线程跑不起来。如果是首次访问,刷新页面让 service worker 注入 COOP/COEP。`,`SharedArrayBuffer / cross-origin isolation not active — multithreaded wasm wont run. On first visit, reload after the service worker installs.`)}),N&&(0,m.jsxs)(`div`,{className:`cubeopt-info`,children:[G&&(0,m.jsx)(c,{size:14,className:`spinning`}),(0,m.jsx)(`span`,{children:N}),G&&(0,m.jsxs)(`button`,{className:`btn-cancel-sm`,onClick:ke,children:[(0,m.jsx)(d,{size:12}),` `,n(`取消`,`Cancel`)]})]}),(0,m.jsxs)(`section`,{className:`cubeopt-card`,children:[(0,m.jsxs)(`div`,{className:`row`,children:[(0,m.jsx)(`span`,{className:`lbl`,children:`Solver`}),(0,m.jsx)(`select`,{className:`ctl`,value:_,disabled:b===`busy`,onChange:e=>_e(e.target.value),children:h.map(e=>(0,m.jsxs)(`option`,{value:e.value,children:[e.value,` (`,e.size,`)`]},e.value))}),(0,m.jsx)(`span`,{className:`size-badge`,children:h.find(e=>e.value===_)?.size})]}),(0,m.jsxs)(`div`,{className:`row`,children:[(0,m.jsx)(`span`,{className:`lbl`,children:n(`Prun 表`,`Prun Table`)}),(0,m.jsx)(`span`,{className:`table-name`,children:v?.table_name??n(`未就绪`,`Not Ready`)}),(0,m.jsxs)(`label`,{className:`auto-dl`,children:[(0,m.jsx)(`input`,{type:`checkbox`,checked:R,onChange:e=>De(e.target.checked)}),(0,m.jsx)(`span`,{children:n(`生成后自动下载`,`Auto-download after gen`)})]}),b===`need-init`&&(0,m.jsxs)(m.Fragment,{children:[(0,m.jsx)(`button`,{className:`btn`,onClick:X,children:n(`生成表`,`Generate Table`)}),(0,m.jsxs)(`button`,{className:`btn`,onClick:je,children:[(0,m.jsx)(ne,{size:14}),` `,n(`上传表`,`Upload Table`)]})]}),b===`ready`&&(0,m.jsxs)(`button`,{className:`btn`,onClick:Z,children:[(0,m.jsx)(a,{size:14}),` `,n(`下载表`,`Download Table`)]}),b===`busy`&&(0,m.jsxs)(`span`,{className:`busy-marker`,children:[(0,m.jsx)(c,{size:14,className:`spinning`}),` `,n(`忙`,`busy`),`…`]}),(0,m.jsx)(`input`,{ref:V,type:`file`,style:{display:`none`},onChange:Me})]}),S>=0&&(0,m.jsx)(`div`,{className:`progress`,children:(0,m.jsx)(`div`,{className:`progress-bar`,style:{width:`${Math.round(S*100)}%`}})})]}),(0,m.jsxs)(`section`,{className:`cubeopt-card`,children:[(0,m.jsxs)(`div`,{className:`row paint-toggle-row`,children:[(0,m.jsx)(`span`,{className:`lbl`,children:n(`从状态`,`From state`)}),(0,m.jsx)(`button`,{className:`btn${F?` is-active`:``}`,onClick:()=>xe(e=>!e),title:n(`画一个魔方状态,自动求出对应打乱`,`Paint a cube state, auto-derive a scramble`),children:F?n(`收起`,`Hide`):n(`展开填色`,`Open paint`)}),(0,m.jsx)(`span`,{className:`paint-hint`,children:n(`点击格子 → 上色 → "求 scramble" → 自动填到下面打乱框,再点 Solve 求最优。`,`Click stickers → paint → "Derive scramble" → fills the box below, then Solve for optimal.`)})]}),F&&(0,m.jsx)(`div`,{className:`paint-wrap`,children:(0,m.jsx)(fe,{facelet:Se,onChange:Ce,activeColor:we,onActiveColorChange:Te,pixelSize:360,solveLabel:{zh:`求 scramble`,en:`Derive scramble`},onSolve:e=>{G||J(e).catch(e=>{P(n(`从状态求解失败:${e.message}`,`Solve from state failed: ${e.message}`))})}})})]}),(0,m.jsxs)(`section`,{className:`cubeopt-card`,children:[(0,m.jsxs)(`div`,{className:`row`,children:[(0,m.jsx)(`span`,{className:`lbl`,children:n(`随机`,`Random`)}),(0,m.jsx)(`select`,{className:`ctl-sm`,value:O,onChange:e=>ve(parseInt(e.target.value,10)),children:pe.map(e=>(0,m.jsxs)(`option`,{value:e,children:[e,` `,n(`步`,`moves`)]},e))}),(0,m.jsx)(`select`,{className:`ctl-sm`,value:k,onChange:e=>ye(parseInt(e.target.value,10)),children:me.map(e=>(0,m.jsxs)(`option`,{value:e,children:[e,` `,n(`个`,`cubes`)]},e))}),(0,m.jsx)(`button`,{className:`btn`,onClick:Pe,children:n(`生成`,`Random`)}),(0,m.jsx)(`button`,{className:`btn-icon`,onClick:Fe,title:n(`每行反向`,`Invert each line`),children:(0,m.jsx)(l,{size:14})}),(0,m.jsx)(`button`,{className:`btn-icon${I?` is-active`:``}`,onClick:()=>Ee(e=>!e),title:n(`打乱图预览(显示第一行打乱产生的状态)`,`Show preview of the first scramble`),children:I?(0,m.jsx)(s,{size:14}):(0,m.jsx)(o,{size:14})}),(0,m.jsx)(`button`,{className:`btn-icon`,onClick:()=>D(``),title:`Clear`,children:(0,m.jsx)(u,{size:14})})]}),(0,m.jsx)(`textarea`,{className:`scramble-area`,rows:5,placeholder:`R U R' U' R' F R2 U' R' U' R U R' F'`,value:E,onChange:e=>D(e.target.value)}),I&&$&&(0,m.jsxs)(`div`,{className:`scramble-preview`,children:[(0,m.jsx)(te,{event:`333`,scramble:$,visualization:`2D`,size:28,className:`scramble-preview-svg`}),(0,m.jsx)(`span`,{className:`scramble-preview-label`,children:n(`应用第一行打乱后的状态`,`State after the first scramble`)})]}),(0,m.jsxs)(`div`,{className:`row`,children:[(0,m.jsx)(`span`,{className:`lbl`,children:n(`线程`,`Threads`)}),(0,m.jsx)(`select`,{className:`ctl-sm`,value:A,onChange:e=>be(parseInt(e.target.value,10)),children:Array.from({length:navigator.hardwareConcurrency||4},(e,t)=>t+1).map(e=>(0,m.jsx)(`option`,{value:e,children:e},e))}),(0,m.jsx)(`span`,{className:`lbl`,children:n(`并发块`,`Concurrent`)}),(0,m.jsx)(`select`,{className:`ctl-sm`,value:j,onChange:e=>M(parseInt(e.target.value,10)),children:Ie.map(e=>(0,m.jsx)(`option`,{value:e,children:e},e))}),b===`busy`?(0,m.jsxs)(`button`,{className:`btn-cancel`,onClick:Ae,title:n(`终止当前任务。会重建 wasm,prun 表会丢失需重新生成或上传。`,`Abort current task. Wasm will be reset; prun table is lost and must be re-generated or uploaded.`),children:[(0,m.jsx)(d,{size:14}),` `,n(`取消`,`Cancel`)]}):(0,m.jsx)(`button`,{className:`btn-primary`,disabled:b===`no-solver`||!Le,onClick:Ne,title:b===`need-init`?n(`会先自动生成 prun 表(几十秒)再求解`,`Will auto-generate the prun table (tens of seconds) then solve`):void 0,children:b===`need-init`?(0,m.jsxs)(m.Fragment,{children:[(0,m.jsx)(l,{size:14}),` `,n(`生成表+求解`,`Gen Table + Solve`)]}):(0,m.jsx)(m.Fragment,{children:`Solve`})})]})]}),(0,m.jsxs)(`section`,{className:`cubeopt-card`,children:[(0,m.jsxs)(`div`,{className:`row`,children:[(0,m.jsx)(`span`,{className:`lbl`,children:`Logs`}),(0,m.jsx)(`button`,{className:`btn-icon`,onClick:()=>T(``),title:`Clear logs`,children:(0,m.jsx)(u,{size:14})})]}),(0,m.jsx)(`textarea`,{ref:H,className:`logs-area`,rows:10,value:w,readOnly:!0})]}),(0,m.jsxs)(`p`,{className:`cubeopt-foot`,children:[`Inspired by `,(0,m.jsx)(`a`,{href:`https://github.com/cs0x7f/cubeopt-wasm`,target:`_blank`,rel:`noopener noreferrer`,children:`cs0x7f/cubeopt-wasm`}),` (BSD-3), original demo at `,(0,m.jsx)(`a`,{href:`https://cstimer.net/cubeopt/`,target:`_blank`,rel:`noopener noreferrer`,children:`cstimer.net/cubeopt`}),`.`]})]})}var ge=`
.cubeopt-page {
  max-width: 920px;
  margin: 0 auto;
