import"./react-BHPi-aqk.js";import{t as e}from"./LangToggle-ETzSaVn1.js";import{t}from"./useTranslation-azoUBVHB.js";import{n}from"./chunk-LFPYN7LY-DZAbSnaa.js";import{t as r}from"./jsx-runtime-DhG3BTtD.js";import{t as i}from"./useDocumentTitle-22a8Ss3G.js";import{n as a,t as o}from"./Lang-CdoufcYP.js";/* empty css                */var s=r(),c=[{slug:`ts`,name:`TypeScript`,href:`/code/language/ts`,accent:`#3178C6`,commentToken:`//`,zhFlavor:`联合类型 number | null + filter 链`,enFlavor:`Union number | null + filter chain`,code:`type Time = number | null; // null = DNF, value in centiseconds
...
ao5 ts
  ...
  where
    ...
    middle = catMaybes (take 3 (drop 1 sorted))`}];function l(e,t){return e.split(`
`).map((e,n)=>{let r=e.indexOf(t);return r===-1||/["']/.test(e.slice(0,r))?(0,s.jsx)(`div`,{children:e||`\xA0`},n):(0,s.jsxs)(`div`,{children:[e.slice(0,r),(0,s.jsx)(`span`,{className:`compare-cmt`,children:e.slice(r)})]},n)})}function u(){let{i18n:r}=t(),u=r.language.startsWith(`zh`)?`zh`:`en`;return i(`17 种语言, 一个 Ao5`,`One Ao5, Seventeen Languages`),(0,s.jsx)(a.Provider,{value:u,children:(0,s.jsxs)(`div`,{className:`compare-root`,children:[(0,s.jsx)(`div`,{className:`compare-bg`}),(0,s.jsxs)(`header`,{className:`compare-head`,children:[(0,s.jsxs)(`div`,{className:`compare-topbar`,children:[(0,s.jsxs)(n,{to:`/code/language`,className:`compare-back`,children:[`← `,(0,s.jsx)(o,{zh:`回 /code/language`,en:`Back to /code/language`})]}),(0,s.jsx)(e,{variant:`inline`})]}),(0,s.jsx)(`div`,{className:`compare-tag`,children:(0,s.jsx)(o,{zh:`// WCA Ao5 · 17 Languages · 1 Algorithm`,en:`// WCA Ao5 · 17 Languages · 1 Algorithm`})}),(0,s.jsx)(`h1`,{className:`compare-title`,children:(0,s.jsx)(o,{zh:(0,s.jsxs)(s.Fragment,{children:[`17 种语言`,(0,s.jsx)(`span`,{className:`compare-comma`,children:`,`}),` 一个 `,(0,s.jsx)(`span`,{className:`compare-hl`,children:`Ao5`})]}),en:(0,s.jsxs)(s.Fragment,{children:[`One `,(0,s.jsx)(`span`,{className:`compare-hl`,children:`Ao5`}),(0,s.jsx)(`span`,{className:`compare-comma`,children:`,`}),` Seventeen Languages`]})})}),(0,s.jsx)(`p`,{className:`compare-sub`,children:(0,s.jsx)(o,{zh:(0,s.jsxs)(s.Fragment,{children:[`同一个 `,(0,s.jsx)(`strong`,{children:`WCA Average-of-5`}),` 算法, 17 种语言写一遍。看每门语言怎么处理"DNF"——这个"成绩不存在"的情况是每个语言类型系统的试金石。`]}),en:(0,s.jsxs)(s.Fragment,{children:[`The same `,(0,s.jsx)(`strong`,{children:`WCA Average-of-5`}),` algorithm, written in seventeen languages. Watch each language handle "DNF" — that "value doesn't exist" case is a litmus test for any type system.`]})})})]}),(0,s.jsxs)(`section`,{className:`compare-rules`,children:[(0,s.jsx)(`h2`,{className:`compare-rules-h`,children:(0,s.jsx)(o,{zh:`WCA Ao5 规则 (60 秒速览)`,en:`The WCA Ao5 rules (in 60 seconds)`})}),(0,s.jsxs)(`ol`,{className:`compare-rules-list`,children:[(0,s.jsx)(`li`,{children:(0,s.jsx)(o,{zh:(0,s.jsxs)(s.Fragment,{children:[`选手做 `,(0,s.jsx)(`strong`,{children:`5 次`}),` 该项目的尝试,记下时间(单位:厘秒)`]}),en:(0,s.jsxs)(s.Fragment,{children:[`Cuber attempts the event `,(0,s.jsx)(`strong`,{children:`5 times`}),`; each result in centiseconds`]})})}),(0,s.jsx)(`li`,{children:(0,s.jsx)(o,{zh:(0,s.jsxs)(s.Fragment,{children:[`把 `,(0,s.jsx)(`strong`,{children:`最快`}),` 和 `,(0,s.jsx)(`strong`,{children:`最慢`}),` 那次去掉`]}),en:(0,s.jsxs)(s.Fragment,{children:[`Drop the `,(0,s.jsx)(`strong`,{children:`fastest`}),` and the `,(0,s.jsx)(`strong`,{children:`slowest`}),` attempt`]})})}),(0,s.jsx)(`li`,{children:(0,s.jsx)(o,{zh:(0,s.jsxs)(s.Fragment,{children:[`剩下中间 3 次的算术平均 = `,(0,s.jsx)(`code`,{children:`Ao5`})]}),en:(0,s.jsxs)(s.Fragment,{children:[`Arithmetic mean of the remaining 3 = `,(0,s.jsx)(`code`,{children:`Ao5`})]})})}),(0,s.jsx)(`li`,{children:(0,s.jsx)(o,{zh:(0,s.jsxs)(s.Fragment,{children:[(0,s.jsx)(`strong`,{children:`DNF`}),`(Did Not Finish)按"无穷大"参与排序——它会被当作"最慢"被丢掉`]}),en:(0,s.jsxs)(s.Fragment,{children:[`A `,(0,s.jsx)(`strong`,{children:`DNF`}),` (Did Not Finish) sorts to the very end — it gets dropped as the "slowest"`]})})}),(0,s.jsx)(`li`,{children:(0,s.jsx)(o,{zh:(0,s.jsxs)(s.Fragment,{children:[`但如果有 `,(0,s.jsx)(`strong`,{children:`≥ 2 次 DNF`}),`,整个 Ao5 也算 `,(0,s.jsx)(`code`,{children:`DNF`})]}),en:(0,s.jsxs)(s.Fragment,{children:[`But with `,(0,s.jsx)(`strong`,{children:`≥ 2 DNFs`}),`, the whole Ao5 itself becomes `,(0,s.jsx)(`code`,{children:`DNF`})]})})})]}),(0,s.jsxs)(`div`,{className:`compare-example`,children:[(0,s.jsx)(`span`,{className:`compare-example-tag`,children:(0,s.jsx)(o,{zh:`示例`,en:`Example`})}),(0,s.jsx)(`code`,{children:`[12.34, 11.22, DNF, 13.45, 10.99]`}),(0,s.jsx)(`span`,{className:`compare-arrow`,children:`→`}),(0,s.jsx)(`code`,{children:`排序: [10.99, 11.22, 12.34, 13.45, DNF]`}),(0,s.jsx)(`span`,{className:`compare-arrow`,children:`→`}),(0,s.jsx)(`code`,{children:(0,s.jsx)(o,{zh:`去头去尾,mean(11.22, 12.34, 13.45) = 12.34s`,en:`drop ends, mean(11.22, 12.34, 13.45) = 12.34s`})})]})]}),(0,s.jsx)(`section`,{className:`compare-grid`,children:c.map(e=>(0,s.jsxs)(`article`,{className:`compare-card`,style:{"--accent":e.accent},children:[(0,s.jsxs)(`header`,{className:`compare-card-h`,children:[(0,s.jsx)(`span`,{className:`compare-card-name`,children:e.name}),(0,s.jsx)(n,{to:e.href,className:`compare-card-link`,children:(0,s.jsx)(o,{zh:`深入读 →`,en:`deep dive →`})})]}),(0,s.jsx)(`pre`,{className:`compare-code`,children:(0,s.jsx)(`code`,{children:l(e.code,e.commentToken)})}),(0,s.jsx)(`footer`,{className:`compare-card-flavor`,children:u===`zh`?e.zhFlavor:e.enFlavor})]},e.slug))}),(0,s.jsxs)(`section`,{className:`compare-takeaway`,children:[(0,s.jsx)(`h2`,{className:`compare-takeaway-h`,children:(0,s.jsx)(o,{zh:`哪里看出门道?`,en:`What to notice`})}),(0,s.jsxs)(`div`,{className:`compare-takeaway-grid`,children:[(0,s.jsxs)(`div`,{children:[(0,s.jsx)(`h3`,{children:(0,s.jsx)(o,{zh:`DNF 这个"空值"`,en:`The DNF empty value`})}),(0,s.jsx)(`p`,{children:(0,s.jsx)(o,{zh:(0,s.jsxs)(s.Fragment,{children:[`17 种语言对"成绩不存在"给出 4 种不同答案:`,(0,s.jsx)(`strong`,{children:`类型联合`}),`(TS `,(0,s.jsx)(`code`,{children:`number | null`}),` / PHP `,(0,s.jsx)(`code`,{children:`?int`}),`)、`,(0,s.jsx)(`strong`,{children:`Option / Optional / Maybe`}),`(Rust / C++ / Swift / Kotlin / Zig / Python / Java boxed null / Mojo `,(0,s.jsx)(`code`,{children:`Optional[Int]`}),` / C# `,(0,s.jsx)(`code`,{children:`int?`}),` / Haskell `,(0,s.jsx)(`code`,{children:`Maybe Int`}),`)、`,(0,s.jsx)(`strong`,{children:`哨兵值`}),`(C / Go / Lua 用 -1)、`,(0,s.jsx)(`strong`,{children:`无类型把门`}),`(JS / Ruby)。AI agent 写代码时, 前两类编译期就能查出 DNF 没处理;后两类要靠测试才发现——JS / Ruby 这一栏是 TS 的反衬。`]}),en:(0,s.jsxs)(s.Fragment,{children:[`Seventeen languages, four distinct answers to "value doesn't exist": `,(0,s.jsx)(`strong`,{children:`union types`}),` (TS `,(0,s.jsx)(`code`,{children:`number | null`}),` / PHP `,(0,s.jsx)(`code`,{children:`?int`}),`), `,(0,s.jsx)(`strong`,{children:`Option / Optional / Maybe`}),` (Rust / C++ / Swift / Kotlin / Zig / Python / Java's boxed null / Mojo's `,(0,s.jsx)(`code`,{children:`Optional[Int]`}),` / C# `,(0,s.jsx)(`code`,{children:`int?`}),` / Haskell `,(0,s.jsx)(`code`,{children:`Maybe Int`}),`), `,(0,s.jsx)(`strong`,{children:`sentinel values`}),` (C / Go / Lua using -1), and `,(0,s.jsx)(`strong`,{children:`no type guard at all`}),` (JS / Ruby). The first two surface unhandled DNFs at compile time; the last two need tests to catch — JS / Ruby are the foil to TS here.`]})})})]}),(0,s.jsxs)(`div`,{children:[(0,s.jsx)(`h3`,{children:(0,s.jsx)(o,{zh:`排序时的"空值放哪"`,en:`Where do empties sort to`})}),(0,s.jsx)(`p`,{children:(0,s.jsx)(o,{zh:(0,s.jsxs)(s.Fragment,{children:[`Kotlin 一行: `,(0,s.jsx)(`code`,{children:`compareBy(nullsLast())`}),`。Ruby `,(0,s.jsx)(`code`,{children:`sort_by`}),` 一句。Python 一行 lambda key。Haskell `,(0,s.jsx)(`code`,{children:`comparing (maybe maxBound id)`}),` 一行。Rust 要 4 行 match 穷尽。Zig 要包一个内联结构体。同样的语义, 代码量差 5×——这就是"语言密度"的真实差距。`]}),en:(0,s.jsxs)(s.Fragment,{children:[`Kotlin in one line: `,(0,s.jsx)(`code`,{children:`compareBy(nullsLast())`}),`. Ruby `,(0,s.jsx)(`code`,{children:`sort_by`}),` in one line. Python in one lambda key. Haskell with `,(0,s.jsx)(`code`,{children:`comparing (maybe maxBound id)`}),` in one line. Rust takes a four-arm exhaustive match. Zig wraps it in an inline struct. Same semantics, 5× variance in line count — the real "language density" gap.`]})})})]}),(0,s.jsxs)(`div`,{children:[(0,s.jsx)(`h3`,{children:(0,s.jsx)(o,{zh:`高阶函数 vs 命令式`,en:`Higher-order vs imperative`})}),(0,s.jsx)(`p`,{children:(0,s.jsx)(o,{zh:(0,s.jsxs)(s.Fragment,{children:[`Python / Swift / Kotlin / TS 用 `,(0,s.jsx)(`code`,{children:`filter / map / reduce / sorted`}),` 链式表达"管道"风格;C / Zig 仍走 `,(0,s.jsx)(`code`,{children:`for`}),` 循环 + 中间数组的命令式。Rust 介于两者之间——既能 iterator chain 又能 imperative。`]}),en:(0,s.jsxs)(s.Fragment,{children:[`Python / Swift / Kotlin / TS lean on `,(0,s.jsx)(`code`,{children:`filter / map / reduce / sorted`}),` chains in a pipeline style; C and Zig still go imperative with `,(0,s.jsx)(`code`,{children:`for`}),` loops and scratch arrays. Rust sits in between — iterator chains or imperative, both feel native.`]})})})]}),(0,s.jsxs)(`div`,{children:[(0,s.jsx)(`h3`,{children:(0,s.jsx)(o,{zh:`错误 / 边界处理`,en:`Errors / boundary handling`})}),(0,s.jsx)(`p`,{children:(0,s.jsx)(o,{zh:(0,s.jsxs)(s.Fragment,{children:[`WCA 规则要求恰好 5 次尝试。在 Rust / Zig / C++ 里这通过`,(0,s.jsx)(`strong`,{children:`定长数组类型`}),` `,(0,s.jsx)(`code`,{children:`[Time; 5]`}),` 编译期就保证了——参数过短直接编译失败。Python / TS 用 `,(0,s.jsx)(`code`,{children:`list`}),`,要靠运行时 `,(0,s.jsx)(`code`,{children:`assert`}),` 检查。`]}),en:(0,s.jsxs)(s.Fragment,{children:[`WCA rules demand exactly 5 attempts. Rust / Zig / C++ guarantee this with `,(0,s.jsx)(`strong`,{children:`fixed-size array types`}),` like `,(0,s.jsx)(`code`,{children:`[Time; 5]`}),` — too few args, won't compile. Python / TS use `,(0,s.jsx)(`code`,{children:`list`}),`, so they need a runtime `,(0,s.jsx)(`code`,{children:`assert`}),`.`]})})})]})]})]}),(0,s.jsxs)(`footer`,{className:`compare-foot`,children:[(0,s.jsxs)(`div`,{className:`compare-foot-line`,children:[(0,s.jsx)(o,{zh:`想看更多对比示例?`,en:`Want more comparison examples?`}),(0,s.jsx)(`span`,{className:`compare-meta-dot`,children:`·`}),(0,s.jsx)(n,{to:`/code/language`,children:(0,s.jsx)(o,{zh:`回 /code/language 主页`,en:`Back to /code/language`})})]}),(0,s.jsx)(`p`,{className:`compare-foot-note`,children:(0,s.jsx)(o,{zh:(0,s.jsxs)(s.Fragment,{children:[`第二篇横向对比已经上了:`,(0,s.jsx)(n,{to:`/code/language/scramble`,children:`打乱解析器, 17 种语言`}),`。`]}),en:(0,s.jsxs)(s.Fragment,{children:[`The second comparison is live: `,(0,s.jsx)(n,{to:`/code/language/scramble`,children:`scramble parser, seventeen languages`}),`.`]})})})]})]})})}export{u as default};