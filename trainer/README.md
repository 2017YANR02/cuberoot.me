...
| i18n | 列表页列头 + 详情页 Meta + 提交页字段标签均支持中英文 |

### 待完成

| 功能 | 说明 |
|------|------|
| ~~WCA OAuth~~ | ✅ 已完成（auth_store.ts + AuthCallbackPage.tsx） |
| ~~Fastify 后端~~ | ✅ 代码已完成（20 端点），待部署到 ECS 替换 PHP |
| ~~虚拟键盘~~ | ✅ 已完成（CubeVirtualKeyboard.tsx：双页布局、手势、联想、Shift 三态） |
