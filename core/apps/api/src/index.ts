...
import { wcaPersonRoutes } from './routes/wca_person.js';
...
import { trafficDrainRoutes } from './routes/traffic_drain.js';
import { pageNoticesRoutes } from './routes/page_notices.js';
import { patternExamplesRoutes } from './routes/pattern_examples.js';
import { creatorGalleryRoutes } from './routes/creator_gallery.js';
import { simMasksRoutes } from './routes/sim_masks.js';
...
import { algPreferredAlgsRoutes } from './routes/alg_preferred_algs.js';
import { algSrsRoutes } from './routes/alg_srs.js';
import { algSweepRoutes } from './routes/alg_sweep.js';
...
app.onError((err, c) => {
  ...
  else if (msg.includes('Admin access required') || msg.includes('Drive access required') || msg.includes('Music membership required') || msg.includes('Vault membership required') || msg.includes('Cannot edit') || msg.includes('Cannot delete') || msg.includes('suspended')) status = 403;
...
app.route('/v1', trafficDrainRoutes);
app.route('/v1', pageNoticesRoutes);
app.route('/v1', patternExamplesRoutes);
app.route('/v1', creatorGalleryRoutes);
app.route('/v1', simMasksRoutes);
...
app.route('/v1', algPreferredAlgsRoutes);
app.route('/v1', algSrsRoutes);
app.route('/v1', algSweepRoutes);
...
app.route('/v1', wechatPcOpenSdkRoutes);
