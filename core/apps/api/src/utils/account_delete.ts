...
export const NOT_USER_OWNED: Readonly<Record<string, string>> = {
  ...
  platform_competition_sessions: '比赛场次属于活动，监督员账号随删除置空',
  platform_competition_disputes: '成绩申诉与裁决历史保留，申请人与处理人账号随删除置空',
  platform_competition_settlement_ledger: '比赛结算凭证不可变保留，操作者账号随删除置空并保留审计键',
  platform_organizer_applications: '主办方申请保留审核资料，申请人外键 RESTRICT 阻止注销，审核人账号随删除置空',
