...
pnpm --filter @cuberoot/client-next dev   # http://127.0.0.1:3000/frame-count
```
...
rm -rf packages/client-next               # 物理删除 POC workspace
...
| TypeScript strict typecheck | ✅ | `pnpm --filter @cuberoot/client-next typecheck` clean |
