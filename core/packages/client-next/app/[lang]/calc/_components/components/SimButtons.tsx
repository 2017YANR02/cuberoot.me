            ...
            <div className="info-modal-body">
              {i18n.language === 'zh-Hant' ? ((
                                          <>
                                            ...
                                            <p><strong>🎲 隨機</strong> — 使用<em>核密度估計 (KDE)</em>隨機填充空格。對每位選手，從其官方 Ao100 中隨機取樣一把真實成績，然後疊加高斯擾動（頻寬來自 Silverman 法則：h = 0.9·min(σ, IQR/1.34)·n<sup>−0.2</sup>）。這會在其真實水平附近產生平滑、真實的波動。沒有 Ao100 資料的專案（333fm、444bf、555bf）退回到對數正態分佈。若所有格子已填滿，隨機會覆蓋全部值。</p>
