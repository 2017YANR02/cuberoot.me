  ...
  return (
    <div className="bld-trainer-root">
      <div className="bld-topbar">
        <h1>{isZh ? '盲拧资源' : '3BLD Resources'}</h1>
      </div>

      <p className="bld-res-intro">
        {isZh
          ? '整合了国内外的三盲（3BLD）学习资源：视频与图文教程、交换子讲解、公式集、记忆方法以及常用工具。资源原汇总来自勺子的 bldtrainer，外链均跳转至原作者发布页。'
          : 'A curated set of 3BLD learning resources: video & written tutorials, commutator explainers, algorithm sheets, memory methods, and tools. Originally compiled in Zhi Qiao’s bldtrainer; every link points to its original author.'}
      </p>
