...
export const NEXT_JS: StackTool = {
  ...
  zh: {
    ...
    cuberootDesc: <>2026-05 的 Phase 4 把整站从 Vite SPA 切成 Next 16 App Router, client-next 现在是主工作区。同一份代码双线部署: 自有服务器的 systemd standalone + Vercel。</>,
    outlookTitle: '当下与前景',
  ...
  en: {
    ...
    cuberootDesc: <>Phase 4 (2026-05) cut the whole site from a Vite SPA to Next 16 App Router; client-next is now the primary workspace. The same code deploys two ways: a systemd standalone server on the VM, and Vercel.</>,
