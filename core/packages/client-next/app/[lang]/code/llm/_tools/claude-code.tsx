...
export const CLAUDE_CODE: StackTool = {
  ...
  zh: {
    ...
    cuberootDesc: <>本站 100% 在 Claude Code 里维护。多 AI 并行 (这一页就是 5 个 subagent 同时写)、hooks 强制 typecheck、CLAUDE.md 跨会话记忆、<code>/security-review</code> 提交前过一遍、skills 把项目惯例 (theme tokens / i18n / comp schema) 自动接入。</>,
    outlookTitle: '当下与前景',
  ...
  en: {
    ...
    cuberootDesc: <>cuberoot.me is maintained 100% inside Claude Code. Multi-AI parallelism (this page is five subagents writing concurrently), hooks enforcing typecheck, CLAUDE.md memory crossing sessions, <code>/security-review</code> before major commits, and skills wiring up project conventions (theme tokens / i18n / comp schema) automatically.</>,
