      ...
      <div className="compare-root">
        ...
        <footer className="compare-foot">
          ...
          <p className="compare-foot-note">
            <L
              zh={<>第二篇横向对比已经上了:<Link href="/code/language/scramble">打乱解析器, 17 种语言</Link>。</>}
              en={<>The second comparison is live: <Link href="/code/language/scramble">scramble parser, seventeen languages</Link>.</>}
            />
          </p>
        </footer>
      </div>
