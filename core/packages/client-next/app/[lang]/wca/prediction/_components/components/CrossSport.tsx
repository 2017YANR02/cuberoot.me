    ...
    <section className="pred-section" id="cross-sport">
      ...
      <p>
        {i18n.language === 'zh-Hant' ? ((
                        <>「WR 佔理論極限的百分比」是判斷「一項運動成不成熟, 還剩多少空間」的最直接指標。速擰兩項放到一起看: 2x2 已經接近反應時間牆,3x3 還有近一半空間。跟傳統競技專案對比一下,3x3 現在的位置更接近 1990 年代的馬拉松,而不是今天的馬拉松。</>
                      )) : (isZh ? (
      ...
      <p className="pred-note">
        {i18n.language === 'zh-Hant' ? ((
                        <>
                          ...
                          <strong>但跑步, 打字這種「撞到解剖學硬牆」的專案,25-30 年零進展是常態。</strong> 速擰 3x3 目前位置 (54%) 夾在兩種軌跡之間,沒有定論。
                        </>
                      )) : (isZh ? (
                        <>
