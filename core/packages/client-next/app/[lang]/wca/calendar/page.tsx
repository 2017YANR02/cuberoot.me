...
import { loadFlagData, personFlagIso2, compNameZh, countryToIso2 } from '@/lib/country-flags';
    ...
    >
      <header className="upcoming-header">
        ...
        <div className="upcoming-meta">
          <Link href={`/wca/calendar/stats${getLangQuery()}`} className="globe-link">
            <BarChart3 size={12} strokeWidth={1.75} /> {isZh ? '统计' : 'Stats'}
          </Link>
          <Link href="/wca/globe" className="globe-link">
