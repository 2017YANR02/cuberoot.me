...
const TIMELINE: ReadonlyArray<{ year: string; lo: string; hi: string; cite: string; zh: string; en: string; final?: boolean
  ...
  { year: '1946', lo: 'n·c√(log n / log log n)', hi: 'O(n^3/2)', cite: 'Erdős', zh: 'Erdős 提出问题 + 提出猜想 ν(n) ≤ n^(1+C/log log n);K₂,₃-free 给上界 O(n^3/2)', en: 'Erdős states the problem + conjecture ν(n) ≤ n^(1+C/log log n); K₂,₃-free gives upper O(n^3/2)',
      zhHant: "Erdős 提出問題 + 提出猜想 ν(n) ≤ n^(1+C/log log n);K₂,₃-free 給上界 O(n^3/2)"
},
  { year: '1984', lo: 'n·c√(log n / log log n)', hi: 'O(n^4/3)', cite: 'SST', zh: 'Spencer–Szemerédi–Trotter 把上界压到 O(n^4/3),用 incidence bound', en: 'Spencer–Szemerédi–Trotter improve upper to O(n^4/3) via incidence bound',
      zhHant: "Spencer–Szemerédi–Trotter 把上界壓到 O(n^4/3),用 incidence bound"
},
  { year: '1997', lo: '同上', hi: 'O(n^4/3)', cite: 'Sze', zh: 'Székely 用 crossing number 给出 O(n^4/3) 的 1-页证明', en: 'Székely\'s 1-page crossing-number proof of O(n^4/3)',
      zhHant: "Székely 用 crossing number 給出 O(n^4/3) 的 1-頁證明"
},
  { year: '2011', lo: '同上', hi: 'O(n log n)', cite: 'Mat', zh: 'Matoušek 证明大多数范数下 ν 几乎线性 — 暗示 Euclidean 也"应该"如此', en: 'Matoušek: for most norms ν is near-linear — suggesting Euclidean "should" be too',
      zhHant: "Matoušek 證明大多數範數下 ν 幾乎線性 — 暗示 Euclidean 也\"應該\"如此"
},
  { year: '2022', lo: '同上', hi: 'O(n^4/3) (constant ↓)', cite: 'ÁP', zh: 'Ágoston & Pálvölgyi 改进 n^4/3 的常数(40 年来唯一进展)', en: 'Ágoston & Pálvölgyi sharpen the constant in n^4/3 (only progress in 40 yrs)',
      zhHant: "Ágoston & Pálvölgyi 改進 n^4/3 的常數(40 年來唯一進展)"
},
  { year: '2025', lo: '同上', hi: 'O(n log² n) generic', cite: 'ABS / GST', zh: 'Alon–Bucić–Sauermann + Greilhuber–Schildkraut–Tidor:对几乎所有 d 维范数,ν ≤ (d/2 ± o(1)) n log² n', en: 'Alon–Bucić–Sauermann + Greilhuber–Schildkraut–Tidor: ν ≤ (d/2 ± o(1)) n log² n for nearly all d-dim norms',
      zhHant: "Alon–Bucić–Sauermann + Greilhuber–Schildkraut–Tidor:對幾乎所有 d 維範數,ν ≤ (d/2 ± o(1)) n log² n"
},
  { year: '2026-05', lo: 'n^(1+δ), δ>0', hi: 'O(n^4/3)', cite: 'OpenAI', zh: 'OpenAI (Chen + 内部模型,Sellke/Sawhney 验证):反例!ν(n) ≥ n^(1+δ) 对无穷多 n — Erdős 猜想 80 年后被否定 (δ 不显式)', en: 'OpenAI (Chen + internal model, Sellke/Sawhney verifying): counterexample! ν(n) ≥ n^(1+δ) for infinitely many n — Erdős\'s 80-yr conjecture falls (δ implicit)',
      zhHant: "OpenAI (Chen + 內部模型,Sellke/Sawhney 驗證):反例!ν(n) ≥ n^(1+δ) 對無窮多 n — Erdős 猜想 80 年後被否定 (δ 不顯式)"
},
  { year: '2026-05', lo: 'n^(1+6·10⁻³⁸)', hi: 'O(n^4/3)', cite: 'Remarks', zh: 'Remarks (9 人联名,arXiv:2605.20695):人类消化版,显式算出 δ ≈ 6 × 10⁻³⁸,简化为 pro-2 塔 + 单一分裂素数', en: 'Remarks (9-author note, arXiv:2605.20695): human-digested, δ ≈ 6 × 10⁻³⁸ explicit; simplified to pro-2 tower + single split prime',
      zhHant: "Remarks (9 人聯名,arXiv:2605.20695):人類消化版,顯式算出 δ ≈ 6 × 10⁻³⁸,簡化為 pro-2 塔 + 單一分裂素數"
},
  { year: '2026-05', lo: 'n^1.014114', hi: 'O(n^4/3)', cite: 'Sawin', zh: 'Sawin 单作 (arXiv:2605.20579):大幅改进,δ ≥ 0.014,离 SST 上界只差约 24 倍', en: 'Sawin solo (arXiv:2605.20579): drastic improvement, δ ≥ 0.014, within factor 24 of SST upper', final: true,
      zhHant: "Sawin 單作 (arXiv:2605.20579):大幅改進,δ ≥ 0.014,離 SST 上界只差約 24 倍"
},
];
    ...
    <div className="unit-distance-page">
      <header className="ud-header">
        <Link href="/math" className="ud-back">
          <ArrowLeft size={16} />
          <span>{t('返回 数学', 'Back to Math', "返回 數學")}</span>
        </Link>
      </header>
      ...
      <main className="ud-main">
        ...
        <section className="ud-hero">
          <div className="ud-eyebrow">
            {t('数学 · 离散几何 · 数论', 'Mathematics · Discrete Geometry · Number Theory', "數學 · 離散幾何 · 數論")}
          </div>
          <h1 className="ud-title">
            {t('平面单位距离问题', 'Planar Unit Distance Problem', "平面單位距離問題")}
            <span className="ud-title-sub">
              {t('Erdős 1946 猜想 — 80 年后被 AI 自主推翻', "Erdős's 1946 conjecture — autonomously disproved by AI, 80 years later", "Erdős 1946 猜想 — 80 年後被 AI 自主推翻")}
            </span>
          </h1>
          <div className="ud-paper-meta">
            ...
            <a href="https://openai.com/index/model-disproves-discrete-geometry-conjecture/" target="_blank" rel="noopener noreferrer">
              <ExternalLink size={13} /> {t('博客', 'Blog', "部落格")}
            </a>
            ...
            <span>{t('2026-05-20 发布', 'released 2026-05-20', "2026-05-20 釋出")}</span>
          </div>
          <p className="ud-lead">
            {i18n.language === 'zh-Hant' ? ((
                                    <>
                                      給平面上 <TeX src="n" /> 個點,最多能有多少對距離恰好等於 <TeX src="1" />?
                                      這是 Erdős 1946 提出的"單位距離問題" — 離散幾何最著名的開放問題之一。
                                      他猜上界是 <TeX src="\nu(n) \le n^{1 + C / \log \log n}" />:一個比任何多項式都慢的次線性增長。
                                      40 年來上界停在 Spencer–Szemerédi–Trotter 的 <TeX src="O(n^{4/3})" />,80 年來下界停在他自己的網格構造。
                                      2026 年,OpenAI 用一個內部模型<em>完全自動地</em>給出了反例:
                                      存在常數 <TeX src="\delta > 0" /> 使得 <TeX src="\nu(n) \ge n^{1 + \delta}" /> 對無窮多 <TeX src="n" /> 成立 — <strong>猜想錯了</strong>。
                                      <br /><br />
                                      本頁用 5 個互動元件拆解這件事:從最基礎的問題陳述,到論文的核心數論構造(Golod–Shafarevich 塔 + CM 域 + Minkowski 嵌入)。
                                    </>
                                  )) : (isZh ? (
                                    <>
          ...
          <div className="ud-numbers">
            <div className="ud-num-card is-erdos">
              ...
              <div className="ud-num-sub">{t('上界 — 现在被推翻', 'upper bound — now disproved', "上界 — 現在被推翻")}</div>
            ...
            <div className="ud-num-card is-sst">
              ...
              <div className="ud-num-sub">{t('40 年来稳坐最佳上界', 'best upper bound for 40 years', "40 年來穩坐最佳上界")}</div>
          ...
          <div className="ud-callout is-ai">
            <span className="ud-callout-h">
              <Sparkles size={14} /> {t('AI 元注释', 'AI meta-note', "AI 元註釋")}
            </span>
            {i18n.language === 'zh-Hant' ? ((
                                    <>
                                      論文專設 "Statement on AI Use" 一節:問題陳述由 AI 撰寫,內部模型自主求解,初次正確性由 AI 評分流水線打分,只有在評分確信無誤<em>之後</em>,人類研究者才介入審閱。後續由數論專家進一步驗證、簡化、加強論證;論文是這條 AI-原始解的"人類編輯版"。
                                    </>
                                  )) : (isZh ? (
                                    <>
        ...
        <section className="ud-section">
          ...
          <ul>
            <li>
              {i18n.language === 'zh-Hant' ? ((
                                          <><strong>什麼:</strong>設 <TeX src="\nu(n)" /> 是平面 n 點集中單位距離對子數的最大值。Erdős 1946 猜想 <TeX src="\nu(n) \le n^{1 + C / \log \log n}" />。</>
                                        )) : (isZh ? (
            ...
            <li>
              {i18n.language === 'zh-Hant' ? ((
                                          <><strong>反例:</strong>存在常數 <TeX src="\delta > 0" />,使得 <TeX src="\nu(n) \ge n^{1+\delta}" /> 對無窮多 n 成立。</>
                                        )) : (isZh ? (
            ...
            <li>
              {i18n.language === 'zh-Hant' ? ((
                                          <><strong>怎麼做:</strong>把 Erdős 經典的 ℤ[i] 網格構造提升到高維。用一個全實數域 L 的無窮無支 pro-3 塔(度數 → ∞,根判別式保持有界),取 K = L(i) 這種 CM 域;Chebotarev 選定的素數在每層完全分裂,產生指數多 |σ(u)| = 1 的元素 u,Minkowski 嵌入到 ℂ^f 中再投影到第一座標,得到 ℝ² 中的點集。</>
                                        )) : (isZh ? (
            ...
            <li>
              {i18n.language === 'zh-Hant' ? ((
                                          <><strong>關鍵技術:</strong>Golod–Shafarevich 不等式保證 pro-3 塔無窮;Frattini 子群論證使新增分裂條件時不降低生成元秩;CM 域 + Minkowski 把"代數 norm-1"翻譯成"幾何 |σ(u)| = 1"。</>
                                        )) : (isZh ? (
            ...
            <li>
              {i18n.language === 'zh-Hant' ? ((
                                          <><strong>AI 元亮點:</strong>問題由 AI 撰寫,內部模型完全自主求解,AI 評分流水線打分後才進入人類審閱。原始模型輸出與論文一同公開。</>
                                        )) : (isZh ? (
        ...
        {/* ─────────────── 3. The problem ─────────────── */}
        <section className="ud-section">
          <h2>{t('3. 问题 — 拖一拖你就懂', '3. The problem — drag the points', "3. 問題 — 拖一拖你就懂")}</h2>
          <p>
            {i18n.language === 'zh-Hant' ? ((
                                    <>給定平面上 n 個不同的點 <TeX src="P \subset \mathbb{R}^2" />,定義</>
                                  )) : (isZh ? (
          ...
          <p>
            {i18n.language === 'zh-Hant' ? ((
                                    <>下面拖點試試。等邊三角形給最高 ν/n(每個三角形邊都是單位距離);切到方格立刻能看出 <em>水平 + 垂直</em> 兩族,但少了對角線那一族。</>
                                  )) : (isZh ? (
        ...
        <section className="ud-section">
          <h2>{t('3.5 上界为什么是 n^(4/3) — 两圆只交两点', '3.5 The upper bound — two circles meet in ≤ 2 points', "3.5 上界為什麼是 n^(4/3) — 兩圓只交兩點")}</h2>
          <p>
            {i18n.language === 'zh-Hant' ? ((
                                    <>先看反方向:為啥 ν(n) <em>不可能</em>太大?最樸素的觀察:單位距離圖不含 <TeX src="K_{2,3}" />。如果點 x、y 都跟 z₁、z₂、z₃ 三個點距離 1,那麼 z₁、z₂、z₃ 同時在以 x 為心半徑 1 的圓上 <em>和</em> 以 y 為心半徑 1 的圓上。<strong>兩個不同的圓最多交兩點</strong>,所以這種 z 最多 2 個,不可能有 3 個。結論:單位距離圖是 K₂,₃-free。</>
                                  )) : (isZh ? (
          ...
          <div className="ud-twocircles-fig">
            <svg viewBox="0 0 360 220" className="ud-twocircles-svg" aria-hidden>
              ...
              <text x={180} y={210} textAnchor="middle"
                ...
                {t('两圆 ≤ 2 交点 ⇒ 无 K₂,₃', 'two circles meet in ≤ 2 points ⇒ no K₂,₃', "兩圓 ≤ 2 交點 ⇒ 無 K₂,₃")}
              </text>
            </svg>
          </div>
          ...
          <p>
            {i18n.language === 'zh-Hant' ? ((
                                    <>由 <strong>Kővári–Sós–Turán 定理</strong>(1954),任何 K₂,₃-free 圖邊數 ≤ <TeX src="\tfrac{1}{2}(1 + \sqrt{4n-3})n^{1/2} \cdot n = O(n^{3/2})" />。Erdős 1946 原文給出的就是這條 <TeX src="O(n^{3/2})" /> 上界。</>
                                  )) : (isZh ? (
          ...
          <p>
            {i18n.language === 'zh-Hant' ? ((
                                    <>1984 年 Spencer–Szemerédi–Trotter 用<strong>點-曲線 incidence 定理</strong>(同年自己證的)把它壓到 <TeX src="O(n^{4/3})" />。1997 年 Székely 給出<strong>用 crossing number 的一頁證明</strong>:把單位距離圖畫在平面上,每對單位距離對應一段單位圓弧;Crossing Lemma <TeX src="\mathrm{cr}(G) \ge c \cdot e^3 / n^2" /> 直接推出 <TeX src="e = O(n^{4/3})" />。這是 40 年來最佳上界,只有常數被微調過(2022 Ágoston–Pálvölgyi)。</>
                                  )) : (isZh ? (
        ...
        {/* ─────────────── 4. Erdős's grid ─────────────── */}
        <section className="ud-section">
          <h2>{t('4. Erdős 1946 的小聪明 — 重定义"单位"', '4. Erdős\'s 1946 trick — redefine "unit"', "4. Erdős 1946 的小聰明 — 重定義\"單位\"")}</h2>

          <Suspense fallback={<div className="ud-loading">Loading…</div>}>
            <ErdosGridHero />
          </Suspense>
          <p className="ud-figure-caption">
            {i18n.language === 'zh-Hant' ? (<>↑ 全解析度精確復刻 — 與 OpenAI 部落格頭圖同構造。每條線都是 <em>恰好</em> √k 長。切換 k 看 r₂(k) 怎麼決定密度。</>) : (isZh
          ...
          <p>
            {i18n.language === 'zh-Hant' ? ((
                                    <>取 √n × √n 整數網格,直接用單位 1 給出的對子數只有 <TeX src="2s(s-1) \approx 2n" />,這是平凡的線性下界。
                                      Erdős 的關鍵觀察:把"單位距離"<em>重定義</em>成 <TeX src="\sqrt{k}" />,其中 k 可以是任何整數。這時,兩點 (x₁, y₁) (x₂, y₂) 之間是"單位距離" ⟺ <TeX src="(x_1 - x_2)^2 + (y_1 - y_2)^2 = k" /> ⟺ k 是兩個整數的平方和。</>
                                  )) : (isZh ? (
          ...
          <p>
            {i18n.language === 'zh-Hant' ? ((
                                    <>設 <TeX src="r_2(k)" /> 是 k 寫成兩整數平方和的方式數。 r₂(1) = 4 ((±1, 0), (0, ±1));但 r₂(5) = 8 ((±1, ±2), (±2, ±1))。在 s×s 網格里,squared-distance = k 的對子數 ≈ <TeX src="\frac{1}{2} \sum_{(a,b): a^2+b^2=k} (s - |a|)(s - |b|)" />,正比於 r₂(k)。</>
                                  )) : (isZh ? (
          ...
          <p>
            {i18n.language === 'zh-Hant' ? ((
                                    <>正是猜想的形式!Erdős 猜的上界與他自己的下界<em>形式</em>一樣,差的是常數 c → C。他相信這就是真實增長。下面拖滑塊改 k 和 s 看看 r₂(k) 怎麼影響 ν 的:</>
                                  )) : (isZh ? (
        ...
        <section className="ud-section">
          <h2>{t('4.5 为什么 Erdős(和所有人)都信这个猜想', '4.5 Why Erdős (and everyone else) believed the conjecture', "4.5 為什麼 Erdős(和所有人)都信這個猜想")}</h2>
          <p>
            {i18n.language === 'zh-Hant' ? ((
                                    <>Erdős 網格構造給的指數 1 + c/log log n 趨近 1,看起來"接近線性";自己的上界 O(n^(3/2)) 後來被 SST 壓到 O(n^(4/3)),離 n^(1+o(1)) 還有距離。從 80 年代起一系列結果都<em>支援</em> n^(1+o(1)) 這邊。</>
                                  )) : (isZh ? (
          ...
          <div className="ud-evidence-cards">
            <div className="ud-evidence-card">
              ...
              <p>
                {i18n.language === 'zh-Hant' ? (<>對 ℝ² 上 <em>大多數</em>(Baire-generic)範數,ν ≤ <TeX src="O(n \log n \log\log n)" /> — <strong>幾乎線性</strong>。</>) : (isZh
            ...
            <div className="ud-evidence-card">
              ...
              <p>
                {i18n.language === 'zh-Hant' ? (<>對 ℝ^d 中 <em>同源</em>(comeagre)範數集,ν ≤ <TeX src="\tfrac{d}{2} n \log^2 n" /> — 任意維度都幾乎線性。</>) : (isZh
            ...
            <div className="ud-evidence-card">
              ...
              <p>
                {i18n.language === 'zh-Hant' ? (<>對<em>所有</em>範數 (不只 comeagre),匹配下界 <TeX src="(d/2 - o(1)) n \log^2 n" />。證據更強了。</>) : (isZh
          ...
          <div className="ud-callout">
            <span className="ud-callout-h">{t('为什么 Euclidean 跳出了"通用"', 'Why Euclidean breaks the pattern', "為什麼 Euclidean 跳出了\"通用\"")}</span>
            {i18n.language === 'zh-Hant' ? ((
                                    <>
                                      所有"通用範數"幾乎線性的結果,都依賴範數 ball 沒有特殊算術結構。但 Euclidean 單位圓 <TeX src="x^2 + y^2 = 1" /> 有<em>極特殊</em>的算術結構:Gauss 整數 ℤ[i] 上"<TeX src="\mathrm{norm} = 1" />"對應 <TeX src="zz̄ = 1" />,這是數論的入口。
                                      提升到 CM 域 K = L(i) 後,<em>所有</em> 復嵌入下 |σ(u)| = 1 的元素都來自相同代數機制 — Erdős 猜想<em>不</em>錯在直覺上"應該幾乎線性",而錯在他沒把<strong>Euclidean 本身就是反例</strong>看作可能。AI 注意到的正是這個。
                                    </>
                                  )) : (isZh ? (
                                    <>
          ...
          <p>
            {i18n.language === 'zh-Hant' ? ((
                                    <>Bloom 在 Remarks §4 直白說:"<em>大部分人在這個問題上花的時間,都在試圖證明上界,而不是證偽。</em>" — 80 年的人類研究在錯的方向用力。</>
                                  )) : (isZh ? (
        ...
        {/* ─────────────── 5. Bounds & history ─────────────── */}
        <section className="ud-section">
          <h2>{t('5. 80 年的上下界拉锯', '5. 80 years of bound-tightening', "5. 80 年的上下界拉鋸")}</h2>
          ...
          <div className="ud-timeline">
            {TIMELINE.map((row, i) => (
              <div key={i} className={`ud-timeline-row ${row.final ? 'is-final' : ''}`}>
                ...
                <div className="ud-timeline-text">{(i18n.language === 'zh-Hant' ? (row.zhHant ?? row.zh) : (i18n.language.startsWith('zh') ? row.zh : row.en))}</div>
              </div>
            ))}
          </div>
          ...
          <p>
            {i18n.language === 'zh-Hant' ? ((
                                    <>
                                      這張圖把上面所有界畫在 <em>指數</em> α = log ν / log n 這個量上。
                                      這是看清"猜想被反駁"的最直接方式:
                                      Erdős 猜想的上界是一條 <em>下降到 1</em> 的曲線 (1 + C/log log n);
                                      新下界是 <em>水平直線</em> (1 + δ);水平線必然穿過下降到 1 的曲線。
                                    </>
                                  )) : (isZh ? (
                                    <>
        ...
        <section className="ud-section">
          <h2>{t('5.5 Erdős 1946 同篇里的另一题:不同距离问题', '5.5 The other problem in Erdős 1946: distinct distances', "5.5 Erdős 1946 同篇裡的另一題:不同距離問題")}</h2>
          <p>
            {i18n.language === 'zh-Hant' ? ((
                                    <>Erdős 1946 那篇<em>同時</em>提出兩個對偶的離散幾何問題。一個是單位距離 ν(n)(本頁主題);另一個是 <strong>不同距離 D(n)</strong>:n 個平面點能有<em>最少</em>多少種不同的兩兩距離?</>
                                  )) : (isZh ? (
          ...
          <div className="ud-dual-grid">
            <div className="ud-dual-card">
              <div className="ud-dual-h">{t('单位距离 ν(n)', 'Unit distances ν(n)', "單位距離 ν(n)")}</div>
              <div className="ud-dual-q">{t('一个特定距离最多重复多少次?', 'how often can ONE distance repeat?', "一個特定距離最多重複多少次?")}</div>
              ...
              <div className="ud-dual-row">
                <span className="ud-compare-k">{t('当前最佳上界', 'best upper', "當前最佳上界")}</span>
                <span className="ud-compare-v"><TeX src="O(n^{4/3})" /> (SST 1984)</span>
              </div>
              <div className="ud-dual-row">
                <span className="ud-compare-k">{t('当前最佳下界', 'best lower', "當前最佳下界")}</span>
                <span className="ud-compare-v"><TeX src="n^{1.014}" /> (Sawin 2026)</span>
              </div>
              <div className="ud-dual-row">
                <span className="ud-compare-k">{t('状态', 'status', "狀態")}</span>
                <span className="ud-compare-v ud-status-open">{t('猜想被推翻,gap 仍大', 'conjecture false, big gap')}</span>
              </div>
            </div>
            <div className="ud-dual-card">
              <div className="ud-dual-h">{t('不同距离 D(n)', 'Distinct distances D(n)', "不同距離 D(n)")}</div>
              <div className="ud-dual-q">{t('最少能有多少种不同距离?', 'how few DISTINCT distances can occur?', "最少能有多少種不同距離?")}</div>
              <div className="ud-dual-row">
                <span className="ud-compare-k">{t('Erdős 猜想', 'Erdős conjecture')}</span>
              ...
              <div className="ud-dual-row">
                <span className="ud-compare-k">{t('状态', 'status', "狀態")}</span>
                <span className="ud-compare-v ud-status-solved">{t('基本解决,差 √log n', 'essentially solved (√log n gap)', "基本解決,差 √log n")}</span>
              </div>
            </div>
          </div>
          ...
          <p>
            {i18n.language === 'zh-Hant' ? ((
                                    <>兩個問題<em>對偶</em>:ν 問"重複多少次最大",D 問"不同種類多少最小"。直覺上 ν · D ≥ n²/2 (鴿籠:n² 個對子分配到 D 種距離裡,最大那個至少佔 n²/(2D))。</>
                                  )) : (isZh ? (
          ...
          <p>
            {i18n.language === 'zh-Hant' ? ((
                                    <>歷史上 D 比 ν 容易得多:Guth–Katz 2015 用 <strong>多項式方法 + 代數幾何</strong>(Dvir 的 finite-field Kakeya 思路升級版),給出 <TeX src="D(n) \ge c \cdot n / \log n" /> — 離 Erdős 猜想 <TeX src="n / \sqrt{\log n}" /> 只差 <TeX src="\sqrt{\log n}" /> 因子。
                                      <strong>ν 反方向</strong>:這次反而是<em>下界</em>被重新整理到 n^1.014,但 Erdős 的猜想方向(認為是上界)<em>錯了</em>。Litt 在 Remarks §6 評論說:"D 的解決用了 polynomial method 這種<em>新工具</em>;ν 的反駁<em>沒</em>引入新幾何工具,只是把數論用得更深 — 這兩題的難度氣質完全不同。"</>
                                  )) : (isZh ? (
        ...
        <section className="ud-section">
          ...
          <div className="ud-theorem">
            ...
            <p style={{ margin: '0.6rem 0 0' }}>
              {i18n.language === 'zh-Hant' ? ((
                                          <>存在絕對常數 <TeX src="\delta > 0" />,以及無窮多正整數 n,使得 <TeX src="\nu(n) \ge n^{1 + \delta}" />。</>
                                        )) : (isZh ? (
          ...
          <p>
            {i18n.language === 'zh-Hant' ? ((
                                    <>這反駁了 Erdős 1946 的猜想 <TeX src="\nu(n) \le n^{1+C/\log\log n}" />:任何形如 <TeX src="n^{1+\delta}" /> 的下界,只要 δ &gt; 0 是常數,就最終 (即 n 足夠大時) 超越 <TeX src="n^{1+C/\log\log n}" />,因為後者的指數 1 + C/log log n 收斂到 1。</>
                                  )) : (isZh ? (
          ...
          <p>
            {i18n.language === 'zh-Hant' ? ((
                                    <>它<em>還</em>反駁了 Erdős–Fishburn 1997 的更強猜想 (任意點都有 ≥ k 等距鄰居 ⟹ k ≤ n^o(1)):構造裡點集的單位距離圖<em>平均度</em>是 n^Ω(1),平均度 ≥ 2k 的圖有最小度 ≥ k 的子圖。</>
                                  )) : (isZh ? (
        ...
        {/* ─────────────── 7. ℤ[i] vs L(i) ─────────────── */}
        <section className="ud-section">
          <h2>{t('7. 经典 ℤ[i] vs 新 L(i)', '7. Classical ℤ[i] vs new L(i)', "7. 經典 ℤ[i] vs 新 L(i)")}</h2>
          <p>
            {i18n.language === 'zh-Hant' ? ((
                                    <>第 4 節那個 r₂(k) 的小聰明,幾何上其實是在 Gauss 整數 ℤ[i] 上做"範數為 k"的分解。在 ℤ[i] 裡,k = q 是 ≡ 1 mod 4 的素數 ⟹ q = π · π̄,π 是 Gauss 素數。許多這樣的 q 乘起來,得到 z ∈ ℤ[i] 滿足 z·z̄ = k,幾何上 z 就是從原點出髮長度為 √k 的格點。</>
                                  )) : (isZh ? (
          ...
          <p>
            {i18n.language === 'zh-Hant' ? ((
                                    <>新構造做的事:把 ℚ 換成更大的全實場 L,把 ℤ[i] 換成 <TeX src="\mathcal{O}_K" /> (其中 K = L(i))。L 的非平凡自同構 c (限制到 K 上的複共軛) 把"復模 = 1"翻譯成"對所有復嵌入 σ 都有 |σ(u)| = 1"。L 的度數 [L:ℚ] → ∞,所以 ℂ^f 是真正的高維空間,可以塞下指數多 norm-1 元素。</>
                                  )) : (isZh ? (
          ...
          <div className="ud-compare-grid">
            <div className="ud-compare-card is-classic">
              <div className="ud-compare-h">{t('经典 1946', 'Classical 1946', "經典 1946")}</div>
              <div className="ud-compare-formula"><TeX src="\mathbb{Z}[i] \subset \mathbb{C} = \mathbb{R}^2" /></div>
              <div className="ud-compare-row">
                <span className="ud-compare-k">{t('维度', 'dim', "維度")}</span>
                <span className="ud-compare-v">2 (固定)</span>
              </div>
              <div className="ud-compare-row">
                <span className="ud-compare-k">{t('共轭', 'conjugation', "共軛")}</span>
                <span className="ud-compare-v">c(a + bi) = a − bi</span>
              </div>
              <div className="ud-compare-row">
                <span className="ud-compare-k">{t('norm-1 元素数', 'norm-1 count', "norm-1 元素數")}</span>
                <span className="ud-compare-v"><TeX src="n^{c/\log\log n}" /></span>
              </div>
              <div className="ud-compare-row">
                <span className="ud-compare-k">{t('给出', 'gives', "給出")}</span>
        ...
        <section className="ud-section">
          <h2>{t('7.5 数论小词典(看懂下面构造前的 8 个词)', '7.5 Number-field glossary (8 terms to know before §8)', "7.5 數論小詞典(看懂下面構造前的 8 個詞)")}</h2>
          <p>
            {i18n.language === 'zh-Hant' ? (<>下面 5 步構造裡反覆出現這幾個詞,先各給一句話直覺 + 一行公式。</>) : (isZh
          ...
          <div className="ud-glossary">
            <div className="ud-glossary-card">
              <div className="ud-glossary-term">{t('全实域 Totally real', 'Totally real field', "全實域 Totally real")}</div>
              <div className="ud-glossary-formula"><TeX src="L \hookrightarrow \mathbb{R}^{[L:\mathbb{Q}]}" /></div>
              <div className="ud-glossary-desc">
                {i18n.language === 'zh-Hant' ? (<>L 的所有共軛嵌入到 ℂ 後<em>全是實數</em>。例:<TeX src="\mathbb{Q}(\sqrt{2})" />,<TeX src="\mathbb{Q}(\zeta_7 + \zeta_7^{-1})" />。</>) : (isZh
            ...
            <div className="ud-glossary-card">
              ...
              <div className="ud-glossary-desc">
                {i18n.language === 'zh-Hant' ? (<>全實域上加 i 得到的全虛二次擴張。非平凡自同構 c 在<em>每個</em>復嵌入下都是普通複共軛。<strong>這是 |σ(u)|=1 ⟺ u·c(u)=1 這條關鍵等價的來源。</strong></>) : (isZh
            ...
            <div className="ud-glossary-card">
              <div className="ud-glossary-term">{t('类数 h(K)', 'Class number h(K)', "類數 h(K)")}</div>
              <div className="ud-glossary-formula"><TeX src="h(K) = \#\mathrm{Cl}(K)" /></div>
              <div className="ud-glossary-desc">
                {i18n.language === 'zh-Hant' ? (<>分式理想 / 主理想 這個商群的大小。等於 1 時 OK 是 PID。<strong>論證裡用作鴿籠分母:2^m 個理想分到 h(K) 個等價類,某類至少 2^m / h(K) 個 — 這就是 norm-1 元素的來源。</strong></>) : (isZh
            ...
            <div className="ud-glossary-card">
              <div className="ud-glossary-term">{t('根判别式 rd(K)', 'Root discriminant rd(K)', "根判別式 rd(K)")}</div>
              <div className="ud-glossary-formula"><TeX src="\mathrm{rd}(K) = |D_K|^{1/[K:\mathbb{Q}]}" /></div>
              <div className="ud-glossary-desc">
                {i18n.language === 'zh-Hant' ? (<>判別式開 n 次根 — 一種"度無關"的複雜度度量。<strong>無支擴張保持根判別式不變</strong>,這就是 Golod–Shafarevich 塔的核心好處:度數→∞ 但 rd 不爆,Minkowski 估計 h(K) ≤ rd(K)^[K:ℚ] 才有用。</>) : (isZh
            ...
            <div className="ud-glossary-card">
              ...
              <div className="ud-glossary-desc">
                {i18n.language === 'zh-Hant' ? (<>無支素 p 上的"提升"自同構,作用 <TeX src="x \mapsto x^{N\mathfrak{p}}" /> mod p。<strong>Frob 類平凡 ⟺ p 在擴張中完全分裂。</strong>Chebotarev 讓我們能選定 Frob 類。</>) : (isZh
            ...
            <div className="ud-glossary-card">
              ...
              <div className="ud-glossary-desc">
                {i18n.language === 'zh-Hant' ? (<>所有極大開子群的交。元素屬於 Φ(G) ⟺ "不當生成元用也無所謂"。<strong>關鍵:把 Φ(G) 裡的元素當關系加進商群,不會降低生成元秩。</strong>這就是為啥可以殺掉選定 Frobenius 而不破壞 Golod–Shafarevich 估計。</>) : (isZh
            ...
            <div className="ud-glossary-card">
              ...
              <div className="ud-glossary-desc">
                {i18n.language === 'zh-Hant' ? (<>有限 p-群的逆極限 — 拓撲群,所有有限商都是 p-群。<strong>無支 pro-p 擴張 F^{`{ur,p}`} 的 Gal 群是這種結構</strong>;Golod–Shafarevich 在這上面才生效(r ≤ d²/4 ⇒ 無窮)。</>) : (isZh
            ...
            <div className="ud-glossary-card">
              <div className="ud-glossary-term">{t('无支扩张', 'Unramified extension', "無支擴張")}</div>
              <div className="ud-glossary-formula"><TeX src="\mathfrak{p}\mathcal{O}_K = \mathfrak{P}_1 \cdots \mathfrak{P}_g" /></div>
              <div className="ud-glossary-desc">
                {i18n.language === 'zh-Hant' ? (<>每個素 p 在 K 中分解時,所有素 P_i 的<em>分支指數</em>都是 1(沒有重複因子)。結果:rd(K) 保持不變。<strong>OpenAI/Sawin 構造的塔每一層都無支</strong>,這是 rd 不爆的源頭。</>) : (isZh
        ...
        <section className="ud-section">
          <h2>{t('8. 构造分 5 步', '8. The construction in 5 stages', "8. 構造分 5 步")}</h2>
          <p>
            {i18n.language === 'zh-Hant' ? ((
                                    <>每一步點開看公式 + 解釋。整體順序:<em>基場 F → pro-3 塔 → CM 擴張 K = F(i) → Minkowski 格 → 切+投影</em>。前 3 步是<strong>數論部分</strong>(構造好"高維 + 多 norm-1 元素"的代數物件),後 2 步是<strong>幾何部分</strong>(把代數物件翻譯成 ℝ² 的點集)。</>
                                  )) : (isZh ? (
        ...
        <section className="ud-section">
          <h2>{t('9. 几何部分:格 → 多圆盘 → 投影', '9. Geometric part: lattice → polydisc → projection', "9. 幾何部分:格 → 多圓盤 → 投影")}</h2>
          <p>
            {i18n.language === 'zh-Hant' ? ((
                                    <>這一節是論文 §2 的視覺化。論文裡 f → ∞,這裡我們退到 f = 2 (Gauss 整數 ℤ[i] in ℂ) 來直觀地看。改 R 看 |X| 和單位距離對怎麼同時指數增長 — 關鍵比是它們的指數差,正比於 1 + δ。</>
                                  )) : (isZh ? (
          ...
          <p>
            {i18n.language === 'zh-Hant' ? ((
                                    <>論文裡的<strong>關鍵引理 2.4</strong>:多圓盤 W 裡某個餘集 a + Λⱼ 至少有 <TeX src="e^{\gamma f_j / 2} |X|" /> 個 X 上的有序對差落在 Uⱼ 中。這就是為什麼投影到第一座標後的 ℝ² 點集 P 有 <TeX src="\nu(P) \ge \frac{1}{2} e^{\gamma f / 2} |P|" /> 個單位距離對 — 遠超平凡的 |P| 量級。</>
                                  )) : (isZh ? (
        ...
        <section className="ud-section">
          <h2>{t('10. AI 自主求解 + 参考', '10. The AI angle + references', "10. AI 自主求解 + 參考")}</h2>

          <div className="ud-quote-block">
            <div className="ud-quote-head">
              {t('引用自论文 — "Statement on AI Use"', 'From the paper — "Statement on AI Use"', "引用自論文 — \"Statement on AI Use\"")}
            </div>
            <blockquote>
              {i18n.language === 'zh-Hant' ? ((
                                          <>"這個問題是<em>完全自動地</em>解決的。我們的內部模型收到一份由 AI 撰寫的問題陳述,其輸出送入 AI 評分流水線,後者給出'高置信度認為解答正確'的判斷。<em>只有在這之後</em>,內部人類研究者和數學家才開始仔細審閱。經過初步的 AI 輔助驗證與重寫,草稿才送給外部數學家,包括若干數論專家,他們確認了證明的正確性(並已經簡化與加強了論證)。本論文是對此自動生成解答的人類編輯版本,補充了參考、重組的證明、與額外解釋材料。"</>
                                        )) : (isZh ? (
          ...
          <p>
            {i18n.language === 'zh-Hant' ? ((
                                    <>這件事在 AI for math 的版圖裡是一個里程碑:不是數學家用 AI 當輔助,而是 AI <em>整個</em>完成了一項數學發現 — 一個 80 年的開放猜想被推翻 — 之後人類才介入。原始模型的輸出與論文一同公開。OpenAI 團隊中 Lijie Chen 用內部模型生成證明,Mark Sellke 和 Mehtaab Sawhney 驗證正確性。</>
                                  )) : (isZh ? (
          ...
          <ul>
            <li>
              {i18n.language === 'zh-Hant' ? ((
                                          <><strong>Remarks 論文</strong>(Alon, Bloom, Gowers, Litt, Sawin, Shankar, Tsimerman, Wang, Wood 聯名,arXiv:2605.20695):人類消化版,把 OpenAI 原始證明裡<em>非顯式</em>的 δ &gt; 0 顯式算出來,得到 <TeX src="\delta \approx 6 \times 10^{-38}" />;並把原始 pro-3 塔證明簡化到 pro-2 塔 + 單一分裂素數(Victor Wang 建議的簡化)。</>
                                        )) : (isZh ? (
            ...
            <li>
              {i18n.language === 'zh-Hant' ? ((
                                          <><strong>Sawin 單作</strong>(arXiv:2605.20579,2026-05-20):大幅改進,得到顯式的 <TeX src="\nu(n) \ge n^{1.014114} / C" />。換算成 δ 是 <TeX src="\delta \ge 0.014" /> — 離上界 <TeX src="n^{4/3}" /> 只差<em>約 24 倍</em>(指數比 <TeX src="(4/3 - 1) / 0.014 \approx 24" />)。Sawin 三個改進:用任意理想代替 <TeX src="\mathcal{O}_K" />、用相對類數代替全類數、按 Frobenius 固定冪商化(不必為 1)。</>
                                        )) : (isZh ? (
          ...
          <p className="ud-text-mute" style={{ fontSize: '0.86rem' }}>
            {i18n.language === 'zh-Hant' ? ((
                                    <>關於"能不能畫一張精確的點集圖":三篇論文都<em>無顯式構造</em>。Remarks §2 給的唯一顯式引數 (<TeX src="T = \{3,5,7,11,13,17\}" />、分裂素數 101、基場 <TeX src="L_T = \mathbb{Q}(\sqrt{5}, \sqrt{13}, \sqrt{17}, \sqrt{21}, \sqrt{33})" /> 32 次多重二次域) 只到 Golod–Shafarevich 這一步,塔的每一層 <TeX src="L_j" /> 是<em>存在性</em>結論,沒有演算法描述。所以"新構造長啥樣"目前沒有圖。</>
                                  )) : (isZh ? (
          ...
          <h3>{t('11. 数学家怎么看 — 引自 Remarks §3-9', '11. What the mathematicians said — quotes from Remarks §3-9', "11. 數學家怎麼看 — 引自 Remarks §3-9")}</h3>
          <div className="ud-reactions">
            <div className="ud-reaction">
              <div className="ud-reaction-who">Noga Alon <span className="ud-reaction-aff">{t('普林斯顿', 'Princeton', "普林斯頓")}</span></div>
              <blockquote>
                {i18n.language === 'zh-Hant' ? (<>"OpenAI 內部模型對此問題的解答,在我看來是<em>傑出的成就</em> — 解決了一個長期懸而未決的問題。正確答案不是 n^(1+o(1)) 這件事本身就令人驚訝,構造與分析對演算法數論工具的運用<em>優雅而巧妙</em>。"</>) : (isZh
            ...
            <div className="ud-reaction">
              <div className="ud-reaction-who">Thomas Bloom <span className="ud-reaction-aff">{t('英国皇家学会大学研究员', 'Royal Society URF', "英國皇家學會大學研究員")}</span></div>
              <blockquote>
                {i18n.language === 'zh-Hant' ? (<>"2026 年 4 月 16 日,我在 erdosproblems.com 發了一篇部落格叫(略帶調侃)'Top 10 Erdős Problems'。單位距離問題是我唯一從離散幾何選的。<em>雖然我相信 AI 早晚會推進這清單上的幾個,我沒想到一個月就來了!</em>"</>) : (isZh
            ...
            <div className="ud-reaction">
              <div className="ud-reaction-who">W. T. Gowers <span className="ud-reaction-aff">{t('剑桥 / 法兰西学院,Fields 奖', 'Cambridge / Collège de France, Fields', "劍橋 / 法蘭西學院,Fields 獎")}</span></div>
              <blockquote>
                {i18n.language === 'zh-Hant' ? (<>"如果人類作者把這篇論文投給《Annals of Mathematics》並讓我快速評審,<em>我會毫不猶豫地推薦接受。此前沒有任何 AI 生成的證明能達到這一標準。</em>……即便後續表明 AI 還不能找需要長 hint sequence 的證明,這種證明對人類也很難找。在 AI 數學進展不至於戛然而止的前提下,我們可能已經進入一個時代:讓人類在解數學問題上跟 AI 競爭會變得很困難。"</>) : (isZh
            ...
            <div className="ud-reaction">
              ...
              <blockquote>
                {i18n.language === 'zh-Hant' ? (<>"這是<em>第一個</em>我發現本身就令人興奮(而非作為'下一步會怎樣'的領先指標)的 AI 自主生成結果。類比:有限域 Kakeya 猜想被 Dvir 用一個簡短而漂亮的論證解決;sensitivity conjecture 被黃昊用一個 elegant argument 解決。這次單位距離問題的解似乎是同一種氣質。"</>) : (isZh
          ...
          <h3>{t('12. 仍开放的问题', '12. Open problems', "12. 仍開放的問題")}</h3>
          <div className="ud-open-grid">
            <div className="ud-open-card">
              <div className="ud-open-h">{t('上下界 gap', 'The bound gap')}</div>
              <p>
                {i18n.language === 'zh-Hant' ? (<>當前 <TeX src="n^{1.014} \le \nu(n) \le O(n^{4/3})" />。差 24 倍指數(<TeX src="(4/3 - 1)/0.014" />)。<strong>真值在哪沒人知道。</strong>可能 4/3 就是答案,可能介於,可能更小。</>) : (isZh
            ...
            <div className="ud-open-card">
              <div className="ud-open-h">{t('SST 上界 40 年没动', 'SST upper bound stuck', "SST 上界 40 年沒動")}</div>
              <p>
                {i18n.language === 'zh-Hant' ? (<>SST 1984 的 <TeX src="O(n^{4/3})" /> 自 1984 以來除常數微調外沒有改進。<strong>能否壓到 <TeX src="O(n^{4/3 - \varepsilon})" />?</strong>會是 40 年來最重大的進展。</>) : (isZh
            ...
            <div className="ud-open-card">
              <div className="ud-open-h">{t('显式构造?', 'Explicit construction?', "顯式構造?")}</div>
              <p>
                {i18n.language === 'zh-Hant' ? (<>目前所有證明都依賴 Golod–Shafarevich 這種<em>存在性</em>論證。<strong>能否給出顯式 P_j 的具體座標?</strong>哪怕一層都好。</>) : (isZh
            ...
            <div className="ud-open-card">
              ...
              <p>
                {i18n.language === 'zh-Hant' ? (<>更強變體:每個點都有 ≥ k 個等距鄰居 ⟹ k ≤ n^o(1)。OpenAI 也<em>順手反駁</em>了這條 — 新構造的平均度是 n^Ω(1)。</>) : (isZh
            ...
            <div className="ud-open-card">
              <div className="ud-open-h">{t('Bloom 的"Top 10"还剩哪些?', 'Bloom\'s "Top 10" — which next?', "Bloom 的\"Top 10\"還剩哪些?")}</div>
              <p>
                {i18n.language === 'zh-Hant' ? (<>2026-04 Bloom 列了 10 個最 prominent 的 Erdős 問題。單位距離一個月內倒下。<strong>下一個會是哪個?</strong>區別在哪?這種"非顯式構造性反例"的成功模式還能複用嗎?</>) : (isZh
            ...
            <div className="ud-open-card">
              <div className="ud-open-h">{t('高维推广', 'Higher dimensions', "高維推廣")}</div>
              <p>
                {i18n.language === 'zh-Hant' ? (<>在 ℝ^d (d ≥ 3) 中相應問題怎樣?Sawin 的方法應該可推廣,但 d=3,4 時的上界 (Erdős-Hickerson) 也已經 Ω(n^{`{4/3}`}) — 現在 d ≥ 3 是不是同樣可達 n^(1+δ) 下界?</>) : (isZh
          ...
          <h3>{t('参考', 'References', "參考")}</h3>
          <ul className="ud-refs">
            <li>
              OpenAI 2026-05-20. <em>{t('平面单位距离点集', 'Planar Point Sets with Many Unit Distances', "平面單位距離點集")}</em>.{' '}
              <a href="https://openai.com/index/model-disproves-discrete-geometry-conjecture/" target="_blank" rel="noopener noreferrer">{t('博客', 'Blog', "部落格")} <ExternalLink size={11} /></a>{' '}·{' '}
            ...
            <li>
              ...
              <em>{t('单位距离猜想反驳的若干注记', 'Remarks on the Disproof of the Unit Distance Conjecture', "單位距離猜想反駁的若干註記")}</em> ({t('人类消化版,显式 δ ≈ 6·10⁻³⁸ + pro-2 简化', 'human-digested, explicit δ ≈ 6·10⁻³⁸ + pro-2 simplification', "人類消化版,顯式 δ ≈ 6·10⁻³⁸ + pro-2 簡化")}).{' '}
              <a href="https://arxiv.org/abs/2605.20695" target="_blank" rel="noopener noreferrer">arXiv:2605.20695 <ExternalLink size={11} /></a>
            </li>
            <li>
              Sawin, W. 2026-05-20.{' '}
              <em>{t('单位距离问题的显式下界', 'An Explicit Lower Bound for the Unit Distance Problem', "單位距離問題的顯式下界")}</em>{' '}
              ({t('大幅改进 δ ≥ 0.014,离 SST 上界仅约 24 倍', 'drastic improvement δ ≥ 0.014, within factor 24 of SST', "大幅改進 δ ≥ 0.014,離 SST 上界僅約 24 倍")}).{' '}
              <a href="https://arxiv.org/abs/2605.20579" target="_blank" rel="noopener noreferrer">arXiv:2605.20579 <ExternalLink size={11} /></a>
            </li>
            <li>
              OpenAI 2026. <em>{t('单位距离问题解答的重写思维链', 'Rewritten Chain of Thought for the Unit Distance Problem', "單位距離問題解答的重寫思維鏈")}</em> ({t('原始 GPT 推理过程公开', 'raw model reasoning, published', "原始 GPT 推理過程公開")}).{' '}
