 ...
 *
 * Output dir is .gitignored — regenerated on every `pnpm --filter @cuberoot/client-next build`.
 */
...
// Prefer the patched version (matches what client-next consumes via pnpm patch);
