...
//
// vitest.config.ts includes 'lib/**/*.test.ts' so `pnpm --filter @cuberoot/client-next test`
// runs this. To run JUST this file:
//     pnpm --filter @cuberoot/client-next exec vitest run lib/pll-fingertricks.test.ts
