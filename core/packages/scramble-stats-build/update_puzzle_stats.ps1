...
$SAMPLED_DIST_EVENTS = @('335', '336', '337', '233', '334', 'crz3a', 'mpyrso', 'dino', 'sq2', 'ssq1', 'bsq', 'cm3', 'heli', 'helicv')   # 已离线采样的 TIER C/D event(随后续 wave 退役各 DistView 现场采样而增长;15p 求解器太慢未接入)
