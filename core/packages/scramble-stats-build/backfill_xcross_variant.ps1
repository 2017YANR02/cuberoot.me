...
[CmdletBinding()]
param(
  [ValidateSet('daisy','f2leo','pseudo_f2leo','222','roux','223','eoline','dr','f2b')]
...
$EXE = @{ daisy = 'daisy_analyzer.exe'; f2leo = 'f2leo_analyzer.exe'; pseudo_f2leo = 'pseudo_f2leo_analyzer.exe'; '222' = 'block222_analyzer.exe'; roux = 'roux_analyzer.exe'; '223' = 'block223_analyzer.exe'; eoline = 'eoline_analyzer.exe'; dr = 'dr_analyzer.exe'; f2b = 'f2b_analyzer.exe' }
