...
export const ALG_CATALOG: Record<AlgPuzzle, AlgSetMeta[]> = {
  '2x2': [
    ...
    { slug: 'leg1',       scd: '',          en: 'LEG-1',      zh: 'LEG-1' },
    { slug: 'tcll-plus',  scd: '',          en: 'TCLL+',      zh: 'TCLL+' },
    { slug: 'tcll-minus', scd: '',          en: 'TCLL-',      zh: 'TCLL-' },
    { slug: 'ls1',        scd: '',          en: 'LS-1',       zh: 'LS-1' },
    { slug: 'ls2',        scd: '',          en: 'LS-2',       zh: 'LS-2' },
    { slug: 'ls3',        scd: '',          en: 'LS-3',       zh: 'LS-3' },
    { slug: 'ls4',        scd: '',          en: 'LS-4',       zh: 'LS-4' },
    { slug: 'ls5',        scd: '',          en: 'LS-5',       zh: 'LS-5' },
    { slug: 'ls6',        scd: '',          en: 'LS-6',       zh: 'LS-6' },
    { slug: 'ls7',        scd: '',          en: 'LS-7',       zh: 'LS-7' },
    { slug: 'ls8',        scd: '',          en: 'LS-8',       zh: 'LS-8' },
    { slug: 'ls9',        scd: '',          en: 'LS-9',       zh: 'LS-9' },
