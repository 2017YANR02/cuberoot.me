...
import type { Face, ParsedMove } from '@cuberoot/puzzle-solvers/cube-moves';
...
import { isCross, isF2l, isOll, isSolved } from './cfop-detect';
import { applyMoves, applyScramble, solved as solvedCube, type CubeFaces } from './state';

export type Orientation = 'U' | 'D' | 'F' | 'B' | 'L' | 'R';
