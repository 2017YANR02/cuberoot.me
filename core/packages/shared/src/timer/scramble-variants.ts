// 打乱分析「变体 + 阶段」的 runtime-neutral 单一真源:变体 key → 显示名(zh/en)+ 规范展示顺序 +
// 每变体的规范阶段键序 + 阶段显示名。
//
...
// 「打乱」是方法下拉里的伪变体:选中即按**原始 WCA 打乱的公式步数**分桶 / 取题(其余变体都是难度
 ...
 * 「整体」查 wca_scramble_optimal.htm、「打乱」直接数打乱公式步数 —— 都不受某场比赛有没有回填
