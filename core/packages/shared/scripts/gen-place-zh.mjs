// 生成全球比赛城市/行政区 → 简体中文 shared 字典,按 WCA 比赛城市裁剪。
...
//
// 重新生成(两步,都在 core/packages/shared 下跑,为 opencc-js 解析):
...
//      node scripts/merge-place-zh.mjs    # + scripts/place-tail-zh.json(LLM 兜底层)→ src/data/place_zh.ts
