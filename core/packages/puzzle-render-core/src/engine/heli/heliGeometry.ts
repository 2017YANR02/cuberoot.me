...
import { roundedSolid, type Plane } from '@cuberoot/puzzle-render-core/engine/polytopeCut';
import { makeSticker } from '@cuberoot/puzzle-render-core/engine/stickerGeom';
