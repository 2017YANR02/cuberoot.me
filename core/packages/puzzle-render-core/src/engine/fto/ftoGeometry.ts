...
import { roundedSolid, polytopeVerts, type Plane } from '@cuberoot/puzzle-render-core/engine/polytopeCut';
import { defaultPlatonicColorSchemes } from '@cuberoot/puzzle-render-core/support/pg-colors';
import {
  offsetInward, roundCorners, extrudeOntoFace, makeSticker, polyArea2,
  schematicPolyFromFacet, type V2,
} from '@cuberoot/puzzle-render-core/engine/stickerGeom';
