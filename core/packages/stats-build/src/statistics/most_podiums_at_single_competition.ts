// NOTE: 单场比赛登台最多
// 与 Ruby _stats_build/statistics/most_podiums_at_single_competition.rb 1:1 对应
import { Statistic } from '../core/statistic.js';

export class MostPodiumsAtSingleCompetition extends Statistic {
  constructor() {
    super();
    this.title = 'Most podiums at a single competition';
    this.titleZh = '单场比赛登台最多';
    this.tableHeader = {
      'Podiums': 'right', 'Person': 'left',
    };
  }
