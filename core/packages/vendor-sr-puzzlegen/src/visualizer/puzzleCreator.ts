...
export function createMegaminxTop(_options: MegaminxOptions = {}): MegaminxTop {
...
export function createSkewb(_options: SkewbOptions = {}): Skewb {
...
export function createSkewbNet(_options: SkewbOptions = {}): SkewbNet {
