...
export class HtmlSvgRenderer extends PolygonRenderer {
  ...
  drawArrow(p1Screen: Vector3, p2Screen: Vector3, uid: number) {
    ...
    if (!this.uidToLine[uid]) {
      ...
      arrow.setAttributeNS(null, "x1", p1Screen.x.toString());
      arrow.setAttributeNS(null, "y1", (-p1Screen.y).toString());
      arrow.setAttributeNS(null, "x2", p2Screen.x.toString());
      arrow.setAttributeNS(null, "y2", (-p2Screen.y).toString());
    }
