...
export class RubiksCubeSimulator extends Simulator {
   ...
   * ```
   */
  private clockwiseSticker(stickerIndex: number): number {
   ...
   */
  private counterClockwiseSticker(stickerIndex: number): number {
   ...
   */
  private oppositeSticker(stickerIndex: number): number {
