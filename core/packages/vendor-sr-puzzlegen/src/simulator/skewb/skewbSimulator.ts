...
const center = (face: string[]): string => face[0];
const topLeft = (face: string[]): string => face[1];
const topRight = (face: string[]): string => face[2];
const bottomLeft = (face: string[]): string => face[3];
const bottomRight = (face: string[]): string => face[4];
