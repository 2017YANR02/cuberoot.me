...
const pieceValue: { [t in PIECE_TYPE]?: number } = {
  [PIECE_TYPE.CORNER]: 2,
  [PIECE_TYPE.EDGE]: 1,
};
...
function solvedTop(scheme: { [face: string]: IColor }): Sqaure1Piece[] {
  return [
    {
...
function solvedBottom(scheme: { [face: string]: IColor }): Sqaure1Piece[] {
  return [
    {
      type: PIECE_TYPE.EDGE,
