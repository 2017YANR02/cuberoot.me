import { ColorCode, ColorName, ColorAbbreviation } from './colors.js'
import { Face } from './cube/constants.js'
...
export const ColorNameToCode: { [name: string]: ColorCode } = {
  ...
  // Extended palette
  [ColorName.Zero]: ColorCode.Zero,
  [ColorName.Forest]: ColorCode.Forest,
  [ColorName.LPink]: ColorCode.LPink,
  [ColorName.Cream]: ColorCode.Cream,
  [ColorName.Cyan]: ColorCode.Cyan,
...
export const ColorAbbreviationToCode: { [name: string]: ColorCode } = {
  ...
  [ColorAbbreviation.Zero]: ColorCode.Zero,
  [ColorAbbreviation.Forest]: ColorCode.Forest,
  [ColorAbbreviation.LPink]: ColorCode.LPink,
  [ColorAbbreviation.Cream]: ColorCode.Cream,
  [ColorAbbreviation.Cyan]: ColorCode.Cyan,
  [ColorAbbreviation.Navy]: ColorCode.Navy,
  [ColorAbbreviation.Tan]: ColorCode.Tan,
}
