...
export const CORE_MASKS: MaskOption[] = [
  ...
  // PHP 的 f2l_1/2/3/sm(「F2L 还剩 N 槽」)= xxxcross / xxcross / xcross / xxcross_diag,
  // 位串逐枚相同,已删 —— 用十字进度那几条 + 拿方朝向转到位。
...
export const EXTENDED_MASKS: MaskOption[] = [
  ...
  { value: Masking.CROSS_HALF_OPP, label: 'Half cross (opposite)' },
  { value: Masking.XCROSS, label: 'XCross' },
  { value: Masking.XXCROSS, label: 'XXCross (adj)' },
  { value: Masking.XXCROSS_DIAG, label: 'XXCross (diag)' },
  { value: Masking.XXXCROSS, label: 'XXXCross' },
...
export const STAGE_SECTIONS: StageSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Xcross', mask: 'xcross' },
      { label: 'XXcross', mask: 'xxcross' },
      { label: 'XXcross_Diag', mask: 'xxcross_diag' },
      { label: 'XXXcross', mask: 'xxxcross' },
