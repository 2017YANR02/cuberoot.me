...
export const EXPLORER_ACHIEVEMENTS = {
  ...
  traveler: { title: { zh: '环球旅人', en: 'World traveler' }, tiers: [10, 20, 50], stat: 'most_visited_countries', description: { zh: '在 10／20／50 个国家或地区正式参赛，以比赛举办地计算，同一地点只计一次。', en: 'Compete officially in 10 / 20 / 50 countries or regions, counted by competition location. Each country or region counts once.' } },
