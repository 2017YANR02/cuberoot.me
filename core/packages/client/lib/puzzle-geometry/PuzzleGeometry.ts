...
// under MPL-2.0, https://mozilla.org/MPL/2.0/). Original: src/cubing/puzzle-geometry/PuzzleGeometry.ts
...
import type { KPuzzleDefinition, KTransformationData } from "cubing/kpuzzle";
