/** Geometry ported from the authorized cubing.pro drawing tool. */

export const SKEWB_NET_SHAPES = [
  {
...
export type SkewbSideLine = {
  ...
  transform: string;
  key: number;
  labelKey: "topLeft" | "topRight" | "right" | "bottomRight" | "bottomLeft" | "left";
  suffix: string;
};

export const SKEWB_SIDE_LINES: SkewbSideLine[] = [
  {
