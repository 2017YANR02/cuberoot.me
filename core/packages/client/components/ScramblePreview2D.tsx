...
const HAS_PREVIEW: Record<string, boolean> = {
  ...
  mirror_333: true, ivy: true, '133': true, '223': true, '233': true, '334': true, '335': true, '336': true, '337': true, '8p': true, '15p': true, sfl: true, ufo: true, cm2: true, cm3: true, heli: true, dmd: true, gear: true, mpyrso: true, dino: true, crz3a: true, sq2: true, ssq1: true, bsq: true, bic: true,
};
