...
export default function RecentScrambles({ lang }: Props) {
  ...
  if (data === undefined) return <div className="recent-scrambles recent-scrambles--loading" data-tour="recent-scrambles" aria-hidden="true" />;
