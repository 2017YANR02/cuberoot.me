...
function MetricPanelsView({ metricPanels, metricGroups, searchTerm, isZh, selectedEvent, hideSelector, activeMetric, onSetActiveMetric, onSetActivePanel, activePanel, belowTabs }: {
  metricPanels: MetricPanel[];
  metricGroups?: MetricGroup[];
  searchTerm: string;
  isZh: boolean;
  ...
  return (
    <div className={wrapperClass}>
      ...
      {headerMode === 'note' && data.note && (
        <p className="wca-stats-note wca-stats-embedded-note">{(isZh ? (data.noteZh ?? data.note) : data.note)}</p>
      )}
