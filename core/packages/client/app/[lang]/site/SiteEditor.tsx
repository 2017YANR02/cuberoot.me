      ...
      <div className="site-editor" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="site-editor-body">
          <label className="site-editor-row">
            ...
            <select className="site-editor-select" value={draft.group} onChange={(e) => set('group', e.target.value as GroupId)}>
              {GROUPS.map((g) => (
          ...
          <label className="site-editor-row">
            ...
            <input className="site-editor-input" value={draft.name} onChange={(e) => set('name', e.target.value)} />
          </label>
          <div className="site-editor-row-2">
            <label>
              <span>{TXT.nameEn[lang]}</span>
              <input className="site-editor-input" value={draft.name_en} onChange={(e) => set('name_en', e.target.value)} />
            </label>
            <label>
              <span>{TXT.nameZh[lang]}</span>
              <input className="site-editor-input" value={draft.name_zh} onChange={(e) => set('name_zh', e.target.value)} />
            </label>
          </div>

          <label className="site-editor-row">
            <span>{TXT.url[lang]} *</span>
            <input className="site-editor-input" value={draft.url} onChange={(e) => set('url', e.target.value)} />
          </label>
          <label className="site-editor-row">
            <span>{TXT.altUrls[lang]}</span>
            <textarea className="site-editor-textarea" rows={2} value={draft.alt_urls_text} onChange={(e) => set('alt_urls_text', e.target.value)} />
          </label>

          <label className="site-editor-row">
            <span>{TXT.author[lang]}</span>
            <input className="site-editor-input" value={draft.author} onChange={(e) => set('author', e.target.value)} />
          </label>

          <label className="site-editor-row">
            <span>{TXT.descEn[lang]}</span>
            <textarea className="site-editor-textarea" rows={2} value={draft.desc_en} onChange={(e) => set('desc_en', e.target.value)} />
          </label>
          <label className="site-editor-row">
            <span>{TXT.descZh[lang]}</span>
            <textarea className="site-editor-textarea" rows={2} value={draft.desc_zh} onChange={(e) => set('desc_zh', e.target.value)} />
          </label>
