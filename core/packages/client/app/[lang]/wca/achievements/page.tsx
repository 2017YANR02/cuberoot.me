...
export default function AchievementsPage() {
  ...
  const badges = [
    ...
    {
      kind: 'slam' as const,
      description: t('同一个项目在世锦赛、洲际赛、国家赛均获得过前三名，并打破过世界纪录。不要求同一年达成，也不要求目前仍保持世界纪录。每个达成项目一枚徽章。', 'Reach the podium at world, continental and national championships in the same event, and have broken a world record in that event. These achievements need not be in the same year, and the record need not still stand. Each qualifying event gets a badge.'),
      href: '/wca/grand-slam',
