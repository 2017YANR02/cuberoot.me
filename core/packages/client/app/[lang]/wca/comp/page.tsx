...
import { loadRecent, recentKeyFor, type RecentEntry } from '@/lib/comp-recent';
...
// 最近浏览(localStorage,登录用户专属)的读写在 lib/comp-recent.ts —— 详情页也要
// rememberRecent,从本模块 import 会把整张日历页拖进它的 bundle。
