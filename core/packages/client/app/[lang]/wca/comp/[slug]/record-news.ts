...
export const COMP_RECORD_NEWS: Partial<Record<string, RecordNews[]>> = {
  WuhanGoldenAutumn2026: [
    ...
    {
      event: '444', person: 'Xuanyi Geng (耿暄一)',
      message: {
  ...
  WuhanCrimsonAutumn2026: [
    {
      event: '333bf', person: 'Yifan Wang (王逸帆)',
      message: {
    ...
    {
      event: '333', round: 3, person: 'Yunzhi Lian (连允之)',
      message: {
    ...
    {
      event: '333oh', person: 'Xuanyi Geng (耿暄一)',
      message: {
        zh: 'PR快讯! 13.30单次, 17.64平均三阶魔方单手双个人纪录PR 耿暄一🇨🇳',
        en: 'PR News! 13.30 Single, 17.64 Avg OH Double PRs Xuanyi Geng🇨🇳',
      },
      results: [{ text: { zh: '13.30 单次，17.64 平均 三阶魔方单手双个人纪录', en: '13.30 Single, 17.64 Avg OH Double' }, tag: 'PR', plural: true }],
    },
    {
      event: '333', round: 2, person: 'Yunzhi Lian (连允之)',
      message: {
