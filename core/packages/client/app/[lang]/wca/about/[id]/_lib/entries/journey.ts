...
WHERE sub_id = 1`,
  ...
  related: [
    ...
    { id: 'name_stats', toStat: true, statHref: '/wca/results?events=__none__', titleZh: '查看实时分布', titleEn: 'Jump to live distribution', hintZh: '各 part 数 + top 国家', hintEn: 'Each part-count + top countries'
    },
  ]
};
