...
export default function CayleyLesson() {
  ...
  return <section id="cayley-bridge">
    ...
    <p>{t('想看每个顶点都画成魔方的完整实例？', 'Want a complete example with a cube at every vertex? ')}<Link href="/math/group/cayley#nauru" prefetch={false}>{t('二阶半转与瑙鲁图：24 个状态、S₄ 同构证明及交互实验', 'Pocket-cube half turns and the Nauru graph: 24 states, a proof of the S₄ isomorphism and an interactive explorer')}</Link></p>
