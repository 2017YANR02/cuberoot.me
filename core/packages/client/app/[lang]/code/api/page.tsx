...
//   account_auth alg alg_chain_order alg_lsll alg_marks alg_srs alg_sets alg_sweep announced_comps article auth battle_rooms calendar cn_comp_names colpi
...
const ENDPOINTS: Ep[] = [
  ...
  { d: 'alg', m: 'GET', p: '/v1/alg/chain-order/:puzzle/:set', g: 'login', zh: '我的公式连拧顺序', en: 'My algorithm chain order' },
  { d: 'alg', m: 'PUT', p: '/v1/alg/chain-order/:puzzle/:set', g: 'login', zh: '保存公式连拧顺序', en: 'Save an algorithm chain order' },
