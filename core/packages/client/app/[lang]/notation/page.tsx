  ...
  return (
    <main className="notation-page">
      <div className="alg-notation-shell notation-shell">
        ...
        <nav className="notation-index" aria-label={t('记号目录', 'Notation index')}>
          <a href="#cube">3×3 / NxN</a>
          <a href="#megaminx">{t('五魔方', 'Megaminx')}</a>
          <a href="#pyraminx">{t('金字塔', 'Pyraminx')}</a>
          <a href="#skewb">{t('斜转', 'Skewb')}</a>
          <a href="#square1">Square-1</a>
          <a href="#clock">{t('魔表', 'Clock')}</a>
          <a href="#fto">FTO</a>
        </nav>

        <section id="cube" className="notation-catalog-section" aria-labelledby="cube-title">
        ...
        <section id="megaminx" className="notation-catalog-section" aria-labelledby="megaminx-title">
          <div className="notation-section-heading">
        ...
        <section id="pyraminx" className="notation-catalog-section" aria-labelledby="pyraminx-title">
          <div className="notation-section-heading">
        ...
        <section id="skewb" className="notation-catalog-section" aria-labelledby="skewb-title">
          <div className="notation-section-heading">
        ...
        <section id="square1" className="notation-catalog-section" aria-labelledby="square1-title">
          <div className="notation-section-heading">
        ...
        <section id="clock" className="notation-catalog-section" aria-labelledby="clock-title">
          <div className="notation-section-heading">
        ...
        <section id="fto" className="notation-catalog-section" aria-labelledby="fto-title">
          <div className="notation-section-heading">
