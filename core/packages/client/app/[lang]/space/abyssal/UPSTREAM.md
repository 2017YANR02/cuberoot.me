...
- Shanghai's 2026-09-08 night adaptation shares a twilight-aware horizon colour between scene fog, the visible sky and the reflection probe. City exposure and bloom belong to the host composer, independently of villa style. The adjustment is disabled outside Shanghai; it does not add upstream global illumination or ray tracing.
