...
const TOPICS: Topic[] = [
  ...
  },
  {
    ...
    href: '/dev/algorithms/cfop-std-solver',
    accent: '#E879A6',
    glyph: '✧',
    available: true,
    zh: {
    ...
    <div className="algos-landing">
      ...
      <header className="algos-landing-head">
        <div className="algos-landing-topbar">
          <Link href="/dev" className="algos-landing-back">← /dev</Link>
        </div>
