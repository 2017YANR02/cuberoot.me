      ...
      body: (
        <>
          ...
          <p>
            ...
            <Link href="/dev/algorithms/cfop-std-solver">CFOP 多阶段求解器</Link>)。
          </p>
        </>
      ),
    },
      ...
      body: (
        <>
          ...
          <p>
            ...
            <Link href="/dev/algorithms/cfop-std-solver">CFOP multi-stage solver</Link> page.
          </p>
        </>
      ),
    }
    ...
    zh: {
      ...
      body: (
        <>
          ...
          <p>
            想看完整对称压缩实现 → <Link href="/dev/algorithms/min2phase">min2phase</Link>。
          </p>
        </>
      ),
    },
      ...
      body: (
        <>
          ...
          <p>
            ...
            <Link href="/dev/algorithms/min2phase">min2phase</Link>.
          </p>
        </>
      ),
    }
          ...
          <table className="algo-table">
            ...
            <tbody>
              <tr>
                ...
                <td><Link href="/dev/algorithms/kociemba">Kociemba</Link></td>
              </tr>
              <tr>
                <td>min2phase</td>
                <td><L zh="Huge sym-compressed (~30MB)" en="Huge sym-compressed (~30MB)" /></td>
                <td className="num"><L zh="< 5ms 平均" en="< 5ms avg" /></td>
                <td><Link href="/dev/algorithms/min2phase">min2phase</Link></td>
              </tr>
              <tr>
                ...
                <td><Link href="/dev/algorithms/cfop-std-solver">CFOP std</Link></td>
              </tr>
            </tbody>
          </table>
        </>
    ...
    zh: {
      ...
      body: (
        <>
          ...
          <ol>
            <li><Link href="/dev/algorithms/kociemba">Kociemba 二阶段</Link> — phase 1 / phase 2 各自一次 IDA*,
              三张子状态剪枝表取 max 当 h。</li>
            <li><Link href="/dev/algorithms/min2phase">min2phase</Link> — phase 1 和 phase 2 交错搜索,
              对称压缩的 huge prune 当 h,几毫秒出解。</li>
            <li><Link href="/dev/algorithms/cfop-std-solver">CFOP std solver</Link> — 5 个 CFOP 阶段
    ...
    en: {
      ...
      body: (
        <>
          ...
          <ol>
            <li><Link href="/dev/algorithms/kociemba">Kociemba two-phase</Link> — one IDA* per phase;
              the max of three sub-state prune tables is h.</li>
            <li><Link href="/dev/algorithms/min2phase">min2phase</Link> — phases interleaved; huge
              symmetry-compressed prune tables; sub-millisecond per solve in steady state.</li>
            <li><Link href="/dev/algorithms/cfop-std-solver">CFOP std solver</Link> — one IDA* per CFOP
      ...
      <div className="algo-page" style={{ ['--accent' as string]: ACCENT }}>
        ...
        <div className="algo-page-inner">
          ...
          <div className="algo-callout">
            ...
            <p>
              <L
                zh={<>看完之后,你应该能读懂 <Link href="/dev/algorithms/kociemba">Kociemba</Link>、<Link href="/dev/algorithms/min2phase">min2phase</Link>、<Link href="/dev/algorithms/cfop-std-solver">CFOP std solver</Link> 三张姐妹页里所有"剪枝表 / admissible h / 4-bit pack"之类术语,而不需要再回头解释。</>}
                en={<>By the end you should be able to read <Link href="/dev/algorithms/kociemba">Kociemba</Link>, <Link href="/dev/algorithms/min2phase">min2phase</Link>, and <Link href="/dev/algorithms/cfop-std-solver">CFOP std solver</Link> without us re-defining "prune table / admissible h / 4-bit pack" anywhere.</>}
              />
            </p>
          </div>
          ...
          <footer className="algo-page-foot">
            <Link href="/">CubeRoot</Link> · <Link href="/dev/algorithms">/dev/algorithms</Link>
          </footer>
        </div>
      </div>
    </LangCtx.Provider>
