...
const HISTORY: HistoryItem[] = [
  ...
  },
  {
    ...
    zh: { title: <>Google I/O — Kotlin first-class on Android</>, desc: <>Android 圈地震：Google 把 Kotlin 列为一等公民。Java 在 Android 上的份额开始让位。<em>这条线后来在 /dev/kotlin 接着讲</em>。Java 在服务端、企业级反而更稳——一刀两段的故事。</> },
    en: { title: <>Google I/O — Kotlin first-class on Android</>, desc: <>An Android-world earthquake: Google promotes Kotlin to first-class status. Java's mobile share starts shrinking. <em>That thread continues over at /dev/kotlin</em>. On the server / enterprise side, meanwhile, Java actually consolidates — a tale of two halves.</> },
  },
  {
          ...
          <div className="footer-grid">
            ...
            <div className="footer-col">
              ...
              <ul>
                ...
                <li><a href="/dev/kotlin"><L zh="Kotlin 章节 — 接力 Android" en="Kotlin chapter — picks up Android" /></a></li>
              </ul>
            </div>
