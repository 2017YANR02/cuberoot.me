        ...
        <main id="top">
          ...
          <section className="section" id="vs">
            <header className="sec-head">
              ...
              <p className="sec-desc"><L
                zh={<>跟 <strong>JavaScript</strong> 比 (<a href="/dev/javascript">/dev/javascript</a>): Web 上的同代对手, 一个跑浏览器一个跑服务器, 30 年并存。跟 <strong>Python</strong> 比 (<a href="/dev/python">/dev/python</a>): 同时代脚本语言, 走向完全不同——Python 进了数据/AI, PHP 留在 Web。跟 <strong>Ruby</strong> 比: 同时代 Web 语言, Rails 跟 Laravel 是同一种东西的不同实现。</>}
                en={<>Versus <strong>JavaScript</strong> (<a href="/dev/javascript">/dev/javascript</a>): the same-generation web peer — one in the browser, one on the server, coexisting for 30 years. Versus <strong>Python</strong> (<a href="/dev/python">/dev/python</a>): same-era scripting language, very different paths — Python went into data and AI, PHP stayed on the web. Versus <strong>Ruby</strong>: same-era web language, Rails and Laravel are the same idea in different implementations.</>}
              /></p>
            </header>
        ...
        <footer className="footer">
          <div className="footer-grid">
            ...
            <div className="footer-col">
              ...
              <ul>
                <li><a href="/dev/javascript"><L zh="JavaScript — 浏览器对手" en="JavaScript — browser counterpart" /></a></li>
                <li><a href="/dev/python"><L zh="Python — 同代脚本语言" en="Python — peer scripting language" /></a></li>
                <li><a href="/dev/java"><L zh="Java — 企业 Web 旧霸主" en="Java — old enterprise web king" /></a></li>
                <li><a href="/dev/c"><L zh="C — PHP 解释器的实现语言" en="C — what PHP itself is written in" /></a></li>
              </ul>
            </div>
