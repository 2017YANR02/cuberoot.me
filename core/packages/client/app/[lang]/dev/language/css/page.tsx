        ...
        <main id="top">
          ...
          <section className="section" id="vs">
            <header className="sec-head">
              ...
              <p className="sec-desc"><L
                zh={<>Web 三层: <a href="/dev/html">HTML</a> 给结构、CSS 给外观、<a href="/dev/javascript">JavaScript</a> (<a href="/dev/ts">TS</a>) 给行为。<strong>每一层都是一门独立语言</strong>, 加起来形成"<em>渐进增强 / progressive enhancement</em>"——没 JS 仍能用, 没 CSS 仍能读。</>}
                en={<>The Web's three layers: <a href="/dev/html">HTML</a> for structure, CSS for appearance, <a href="/dev/javascript">JavaScript</a> (<a href="/dev/ts">TS</a>) for behaviour. <strong>Each is its own language</strong>; together they form <em>progressive enhancement</em> — usable without JS, readable without CSS.</>}
              /></p>
            </header>
        ...
        <footer className="footer">
          <div className="footer-grid">
            ...
            <div className="footer-col">
              ...
              <ul>
                <li><a href="/dev/html"><L zh="HTML — 兄弟语言" en="HTML — the sibling" /></a></li>
                <li><a href="/dev/javascript"><L zh="JavaScript — 行为层" en="JavaScript — behaviour layer" /></a></li>
                <li><a href="/dev/ts"><L zh="TypeScript — JS 加类型" en="TypeScript — JS with types" /></a></li>
                <li><a href="/dev/architecture"><L zh="本站架构" en="This site's architecture" /></a></li>
              </ul>
            </div>
