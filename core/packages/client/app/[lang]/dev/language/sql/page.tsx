        ...
        <main id="top">
          ...
          <section className="section" id="what">
            ...
            <div className="def-grid">
              {[
                ...
                { h: <L zh="不是通用语言" en="Not a general-purpose language" />, tag: 'scope', p: <L zh={<>SQL 本身不能写网页 / 控制硬件 / 跑 ML 训练。它和 <a href="/dev/bash">Bash</a> 同列在"<em>script / query</em>"——专门干一类活, 干 50 年没换。<strong>站着不动也是一种本事</strong>。</>} en={<>SQL itself doesn't write web pages, drive hardware, or train ML. It sits beside <a href="/dev/bash">Bash</a> in the "<em>script / query</em>" bucket — single-purpose, 50 years steady. <strong>Staying perfectly still for half a century is its own kind of skill</strong>.</>} /> },
              ].map((d, i) => (
          ...
          <section className="section" id="vs">
            <header className="sec-head">
              ...
              <p className="sec-desc"><L
                zh={<>SQL 的真对手不是另一门 SQL——是<strong>不同的数据访问范式</strong>。Python <a href="/dev/python">pandas</a> 是命令式数据帧, MongoDB 是文档查询。三种风格, 同样的"取数据"任务。</>}
                en={<>SQL's real competition isn't another SQL — it's <strong>different paradigms for getting at data</strong>. Python <a href="/dev/python">pandas</a> is imperative dataframes; MongoDB is document queries. Three styles, the same "fetch data" task.</>}
              /></p>
            </header>
          ...
          <div className="footer-grid">
            ...
            <div className="footer-col">
              ...
              <ul>
                ...
                <li><a href="/dev/python"><L zh="Python — pandas 对照" en="Python — pandas counterpoint" /></a></li>
                <li><a href="/dev/javascript"><L zh="JavaScript — Drizzle / Prisma" en="JavaScript — Drizzle / Prisma" /></a></li>
                <li><a href="/dev/rust"><L zh="Rust — sqlx / diesel" en="Rust — sqlx / diesel" /></a></li>
                <li><a href="/dev/bash"><L zh="Bash — 同住 script/query 一格" en="Bash — same script/query bucket" /></a></li>
              </ul>
            </div>
