...
const SNIPPETS: Snippet[] = [
  {
    slug: 'ts', name: 'TypeScript', href: '/dev/language/ts', accent: '#3178C6', commentToken: '//',
...
function ao5(times: Time[]): Time {
  ...
  {
    slug: 'rust', name: 'Rust', href: '/dev/language/rust', accent: '#CE422B', commentToken: '//',
...
fn ao5(times: &[Time; 5]) -> Time {
  ...
  {
    slug: 'go', name: 'Go', href: '/dev/language/go', accent: '#00ADD8', commentToken: '//',
...
func ao5(times [5]int) int {
  ...
  {
    slug: 'python', name: 'Python', href: '/dev/language/python', accent: '#3776AB', commentToken: '#',
...
def ao5(times: list[Optional[int]]) -> Optional[int]:
  ...
  {
    slug: 'c', name: 'C', href: '/dev/language/c', accent: '#03579B', commentToken: '//',
...
int ao5(int t[5]) {
  ...
  {
    slug: 'cpp', name: 'C++', href: '/dev/language/cpp', accent: '#00599C', commentToken: '//',
...
Time ao5(std::array<Time, 5> t) {
  ...
  {
    slug: 'zig', name: 'Zig', href: '/dev/language/zig', accent: '#F7A41D', commentToken: '//',
...
fn ao5(times: [5]Time) Time {
  ...
  {
    slug: 'swift', name: 'Swift', href: '/dev/language/swift', accent: '#F05138', commentToken: '//',
  ...
  {
    slug: 'kotlin', name: 'Kotlin', href: '/dev/language/kotlin', accent: '#7F52FF', commentToken: '//',
  ...
  {
    slug: 'java', name: 'Java', href: '/dev/language/java', accent: '#E76F00', commentToken: '//',
...
public static Integer ao5(Integer[] times) {
  ...
  {
    slug: 'js', name: 'JavaScript', href: '/dev/language/javascript', accent: '#E5C100', commentToken: '//',
...
const ao5 = (times) => {
  ...
  {
    slug: 'mojo', name: 'Mojo', href: '/dev/language/mojo', accent: '#FF4B00', commentToken: '#',
...
fn ao5(times: List[Optional[Int]]) -> Optional[Int]:
  ...
  {
    slug: 'csharp', name: 'C#', href: '/dev/language/csharp', accent: '#512BD4', commentToken: '//',
...
public static int? Ao5(int?[] times)
{
  ...
  {
    slug: 'ruby', name: 'Ruby', href: '/dev/language/ruby', accent: '#CC342D', commentToken: '#',
...
def ao5(times)
  ...
  {
    slug: 'php', name: 'PHP', href: '/dev/language/php', accent: '#777BB4', commentToken: '//',
...
function ao5(array $times): ?int {
  ...
  {
    slug: 'lua', name: 'Lua', href: '/dev/language/lua', accent: '#2C2D72', commentToken: '--',
...
local function ao5(times)
  ...
  {
    slug: 'haskell', name: 'Haskell', href: '/dev/language/haskell', accent: '#5E5086', commentToken: '--',
      ...
      <div className="compare-root">
        ...
        <header className="compare-head">
          <div className="compare-topbar">
            <Link href="/dev/language" className="compare-back">
              ← <L zh="回 /dev/language" en="Back to /dev/language" />
            </Link>
          </div>
        ...
        <footer className="compare-foot">
          <div className="compare-foot-line">
            ...
            <Link href="/dev/language"><L zh="回 /dev/language 主页" en="Back to /dev/language" /></Link>
          </div>
          <p className="compare-foot-note">
            <L
              zh={<>第二篇横向对比已经上了:<Link href="/dev/language/scramble">打乱解析器, 17 种语言</Link>。</>}
              en={<>The second comparison is live: <Link href="/dev/language/scramble">scramble parser, seventeen languages</Link>.</>}
            />
          </p>
        </footer>
      </div>
