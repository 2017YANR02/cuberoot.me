...
const HISTORY: HistoryItem[] = [
  ...
  },
  {
    ...
    zh: { title: <>KaTeX 发布 — 浏览器里 100× 快于 MathJax</>, desc: <>Khan Academy (Emily Eisenberg + Sophie Alpert) 发布 <strong>KaTeX</strong>: 只渲染 LaTeX <em>数学子集</em>, 但比 MathJax <strong>快 100 倍</strong>、同步渲染、不闪烁。今天 GitHub README、StackExchange、Notion、本页面都用它。延伸阅读: <a href="/dev/language/katex">/dev/language/katex</a>。</> },
    en: { title: <>KaTeX released — 100× faster than MathJax in the browser</>, desc: <>Khan Academy (Emily Eisenberg + Sophie Alpert) release <strong>KaTeX</strong>: it only renders the LaTeX <em>math subset</em>, but is <strong>100× faster than MathJax</strong>, renders synchronously, never flashes. Today it powers GitHub READMEs, StackExchange, Notion, and this very page. Deep dive: <a href="/dev/language/katex">/dev/language/katex</a>.</> },
  },
  {
    year: '2015',
...
const PROJECTS: Project[] = [
  ...
  {
    href: '/dev/language/katex', highlight: true,
          ...
          <section className="section" id="what">
            ...
            <div className="def-grid">
              {[
                ...
                { h: <L zh="40 年向后兼容" en="40 years of compat" />, tag: 'compat', p: <L zh={<>1985 年 Lamport 写的 LaTeX 文档<strong>在 2026 LaTeX2e 里仍能编译</strong>。同源思想 跟 web 一样: 永远渲染。<em>跟 HTML 兄弟一脉</em>。延伸 <a href="/dev/language/html">/dev/html</a>。</>} en={<>A LaTeX document written by Lamport in 1985 <strong>still compiles under 2026 LaTeX2e</strong>. Same backbone as the web: render forever. <em>Direct sibling philosophy of HTML</em>. See <a href="/dev/language/html">/dev/html</a>.</>} /> },
              ].map((d, i) => (
          ...
          <section className="section" id="math">
            ...
            <div className="ts-grid">
              ...
              <div className="ts-card ts-callout">
                ...
                <p><L
                  zh={<>本页用的是 <strong>KaTeX</strong> ——速度极快 (~100× MathJax), 但<em>只覆盖 LaTeX 数学子集</em>: 没有 TikZ, 没有 \usepackage, 没有 chemfig。完整 LaTeX 编译需要 pdfLaTeX / XeLaTeX / LuaLaTeX 这类引擎。延伸: <a href="/dev/language/katex">/dev/language/katex</a>。</>}
                  en={<>This page renders with <strong>KaTeX</strong> — extremely fast (~100× MathJax), but only covers the <em>LaTeX math subset</em>: no TikZ, no \usepackage, no chemfig. Full LaTeX compilation needs pdfLaTeX / XeLaTeX / LuaLaTeX engines. Deep dive: <a href="/dev/language/katex">/dev/language/katex</a>.</>}
                /></p>
        ...
        <footer className="footer">
          <div className="footer-grid">
            ...
            <div className="footer-col">
              ...
              <ul>
                <li><a href="/dev/language/katex"><L zh="KaTeX — 浏览器数学渲染" en="KaTeX — browser math renderer" /></a></li>
                <li><a href="/dev/language/html"><L zh="HTML — markup 的兄弟" en="HTML — markup sibling" /></a></li>
                <li><a href="/dev/language/css"><L zh="CSS — 表现层" en="CSS — presentation" /></a></li>
