...
const HISTORY: HistoryItem[] = [
  ...
  },
  {
    ...
    zh: { title: <>WWDC: Swift 上线</>, desc: <>Lattner 在 Apple 主导的"现代替代 ObjC"项目终于公开 (<a href="/dev/swift">/dev/swift</a>)。Swift 后来成了 Apple 全栈语言。Lattner 留到 2017。<em>这是他第二门让世界改观的语言, 第三门是 Mojo</em>。</> },
    en: { title: <>WWDC: Swift ships</>, desc: <>The "modern Objective-C replacement" Lattner led inside Apple goes public (<a href="/dev/swift">/dev/swift</a>). Swift becomes Apple's full-stack language. Lattner stays through 2017. <em>It is his second language to reshape an industry; Mojo is the third</em>.</> },
  },
  {
        ...
        <main id="top">
          ...
          <section className="section" id="history">
            <header className="sec-head">
              ...
              <p className="sec-desc"><L
                zh={<>Mojo 不是 2023 年凭空冒出来的——它是 Lattner 从 2003 LLVM 论文一路走来的<strong>第三门语言</strong>。这条线穿过 LLVM、Clang、Swift (<a href="/dev/swift">/dev/swift</a>)、Tesla、Google Brain 的 MLIR, 最后在 Modular 落地。</>}
                en={<>Mojo didn't appear from nowhere in 2023 — it is Lattner's <strong>third language</strong>, on a line that runs from his 2003 LLVM thesis through LLVM, Clang, Swift (<a href="/dev/swift">/dev/swift</a>), Tesla, Google Brain's MLIR, and finally lands at Modular.</>}
              /></p>
            </header>
          ...
          <section className="section" id="vs">
            <header className="sec-head">
              ...
              <p className="sec-desc"><L
                zh={<>跟 <strong>Python</strong> 比: Mojo 是 Python 的"<strong>加速出口</strong>", 不是替代。跨链 <a href="/dev/python">/dev/python</a>。跟 <strong>Swift</strong> 比 (<a href="/dev/swift">/dev/swift</a>): 同一个设计师 Chris Lattner, 但 Swift 给 app 开发者、Mojo 给 ML 编译器工程师——<em>同人, 两个完全不同的受众</em>。</>}
                en={<>Versus <strong>Python</strong>: Mojo is Python's <strong>acceleration off-ramp</strong>, not a replacement. Cross-link <a href="/dev/python">/dev/python</a>. Versus <strong>Swift</strong> (<a href="/dev/swift">/dev/swift</a>): same designer (Chris Lattner), but Swift targets app developers and Mojo targets ML compiler engineers — <em>one person, two completely different audiences</em>.</>}
              /></p>
            </header>
        ...
        <footer className="footer">
          <div className="footer-grid">
            ...
            <div className="footer-col">
              ...
              <ul>
                <li><a href="/dev/swift"><L zh="Swift — Lattner 的第二门语言" en="Swift — Lattner's second language" /></a></li>
                <li><a href="/dev/python"><L zh="Python — Mojo 想加速的目标" en="Python — what Mojo accelerates" /></a></li>
                <li><a href="/dev/rust"><L zh="Rust — 同样的所有权血脉" en="Rust — same ownership lineage" /></a></li>
                <li><a href="/dev/c"><L zh="C — 性能的对照基线" en="C — the perf baseline" /></a></li>
              </ul>
            </div>
