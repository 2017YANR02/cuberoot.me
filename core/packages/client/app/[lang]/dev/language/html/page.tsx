          ...
          <section className="section" id="what">
            ...
            <div className="def-grid">
              {[
                ...
                { h: <L zh="三件套之一" en="One-third of the triad" />, tag: 'web', p: <L zh={<>HTML / CSS / JS 是 web 的三角支柱。HTML = 结构, CSS (<a href="/dev/language/css">/dev/css</a>) = 表现, JS (<a href="/dev/language/javascript">/dev/javascript</a>) = 行为。<em>三者解耦是 1999 HTML 4.01 之后的设计共识</em>。</>} en={<>HTML / CSS / JS are the web's three-legged stool. HTML = structure, CSS (<a href="/dev/language/css">/dev/css</a>) = presentation, JS (<a href="/dev/language/javascript">/dev/javascript</a>) = behaviour. <em>Decoupling the three has been the design consensus since HTML 4.01 in 1999</em>.</>} /> },
              ].map((d, i) => (
        ...
        <footer className="footer">
          <div className="footer-grid">
            ...
            <div className="footer-col">
              ...
              <ul>
                <li><a href="/dev/language/css"><L zh="CSS — 表现层兄弟" en="CSS — the presentation sibling" /></a></li>
                <li><a href="/dev/language/javascript"><L zh="JavaScript — 行为层兄弟" en="JavaScript — the behaviour sibling" /></a></li>
                <li><a href="/dev/language/ts"><L zh="TypeScript — JS 的类型外衣" en="TypeScript — JS's type coat" /></a></li>
