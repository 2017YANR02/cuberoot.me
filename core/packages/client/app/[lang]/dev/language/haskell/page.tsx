        ...
        <footer className="footer">
          <div className="footer-grid">
            ...
            <div className="footer-col">
              ...
              <ul>
                <li><a href="/dev/language/rust"><L zh="Rust — typeclass → trait" en="Rust — typeclass → trait" /></a></li>
                <li><a href="/dev/language/swift"><L zh="Swift — typeclass → protocol" en="Swift — typeclass → protocol" /></a></li>
                <li><a href="/dev/language/ts"><L zh="TypeScript — HKT 讨论" en="TypeScript — HKT discussions" /></a></li>
                <li><a href="/dev/language/mojo"><L zh="Mojo — Lattner 第三门语言" en="Mojo — Lattner's third language" /></a></li>
