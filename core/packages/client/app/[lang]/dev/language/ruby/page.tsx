        ...
        <main id="top">
          ...
          <section className="section" id="vs">
            <header className="sec-head">
              ...
              <p className="sec-desc"><L
                zh={<>跟 <strong>Python</strong> 比 (<a href="/dev/python">/dev/python</a>): 同代 (1991 vs 1995) 的 OO 脚本语言, 选了不同的设计 trade-off。跟 <strong>JavaScript</strong> 比 (<a href="/dev/javascript">/dev/javascript</a>): Web 后端的<em>主要竞争对手</em>——Node 在 2014 起抢走了"<strong>新潮 web 后端</strong>"位置, 但 Ruby/Rails 在<em>业务复杂度高的中型应用</em>仍占优势。</>}
                en={<>Versus <strong>Python</strong> (<a href="/dev/python">/dev/python</a>): a sibling scripting language (1991 vs 1995) that picked different design trade-offs. Versus <strong>JavaScript</strong> (<a href="/dev/javascript">/dev/javascript</a>): its main web-backend competitor — Node took the "<strong>fashionable web back end</strong>" slot from 2014 onward, but Rails still wins on <em>business-complex mid-sized apps</em>.</>}
              /></p>
            </header>
        ...
        <footer className="footer">
          <div className="footer-grid">
            ...
            <div className="footer-col">
              ...
              <ul>
                <li><a href="/dev/python"><L zh="Python — 同代脚本语言" en="Python — sibling scripting language" /></a></li>
                <li><a href="/dev/javascript"><L zh="JavaScript — Web 后端对手" en="JavaScript — web back-end rival" /></a></li>
                <li><a href="/dev/rust"><L zh="Rust — YJIT 后端语言" en="Rust — the YJIT back-end language" /></a></li>
                <li><a href="/dev/ts"><L zh="TypeScript — DHH 公开撤掉" en="TypeScript — what DHH dropped" /></a></li>
                <li><a href="/dev/java"><L zh="Java — Twitter 的 JVM 出口" en="Java — Twitter's JVM exit" /></a></li>
              </ul>
            </div>
