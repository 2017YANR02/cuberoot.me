          ...
          <section className="section" id="pitfalls">
            ...
            <div className="ai-takeaway" style={{ marginTop: 48 }}>
              <p><strong><L zh="一句话总结: " en="In one line: " /></strong><L
                zh={<>Bash 不是 2026 年你想<em>选</em>的语言, 是你<em>已经在用</em>的语言。<strong>承认它、写 strict mode、用 ShellCheck</strong>; 超过 100 行复杂逻辑就切 <a href="/dev/python">Python</a>。<em>这才是诚实的 shell 工程实践</em>。</>}
                en={<>In 2026 bash isn't the language you <em>pick</em> — it's the language you <em>already use</em>. <strong>Own it, run strict mode, use ShellCheck</strong>. Past 100 lines of nontrivial logic, switch to <a href="/dev/python">Python</a>. <em>That's honest shell engineering</em>.</>}
              /></p>
            </div>
          </section>
        </main>
        ...
        <footer className="footer">
          <div className="footer-grid">
            ...
            <div className="footer-col">
              ...
              <ul>
                <li><a href="/dev/python"><L zh="Python — 100 行切走的目标" en="Python — where to graduate to" /></a></li>
                <li><a href="/dev/c"><L zh="C — bash 自己用 C 写的" en="C — bash itself is written in C" /></a></li>
                <li><a href="/dev/rust"><L zh="Rust — nushell 的载体" en="Rust — the language behind nushell" /></a></li>
                <li><a href="/dev/go"><L zh="Go — shfmt 的载体" en="Go — the language behind shfmt" /></a></li>
              </ul>
            </div>
