        ...
        <main id="top">
          ...
          <section className="section" id="vs">
            <header className="sec-head">
              ...
              <p className="sec-desc"><L
                zh={<>跟 <a href="/dev/language/python">Python</a> 比: Lua 是 Python 的<strong>反面</strong>——故意小, 故意 niche。跟 <a href="/dev/language/javascript">JS</a> 比: 都是 1990 年代生的动态脚本, 但 JS 把生态压到浏览器, Lua 压到嵌入。跟 <a href="/dev/language/c">C</a> 比: Lua 的家就是 C, <em>共生关系不是替代关系</em>。</>}
                en={<>Versus <a href="/dev/language/python">Python</a>: Lua is Python's <strong>opposite</strong> — deliberately small, deliberately niche. Versus <a href="/dev/language/javascript">JS</a>: both are 90s dynamic scripts, but JS bet on browsers while Lua bet on embedding. Versus <a href="/dev/language/c">C</a>: Lua's home <em>is</em> C — a symbiosis, not a replacement.</>}
              /></p>
            </header>
        ...
        <footer className="footer">
          <div className="footer-grid">
            ...
            <div className="footer-col">
              ...
              <ul>
                <li><a href="/dev/language/python"><L zh="Python — Lua 的反面" en="Python — Lua's opposite" /></a></li>
                <li><a href="/dev/language/c"><L zh="C — Lua 的家" en="C — Lua's home" /></a></li>
                <li><a href="/dev/language/javascript"><L zh="JavaScript — 同代脚本" en="JavaScript — same-era script" /></a></li>
                <li><a href="/dev/language/rust"><L zh="Rust — 系统语言对照" en="Rust — systems-lang contrast" /></a></li>
              </ul>
            </div>
