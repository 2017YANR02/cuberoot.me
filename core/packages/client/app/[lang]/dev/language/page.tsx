...
function renderTopicCard(t: Topic, lang: 'zh' | 'en') {
  ...
  return t.available ? (
    <Link key={t.slug} href={t.href} className={className} style={{ ['--accent' as string]: t.accent }}>
      {inner}
    </Link>
  ) : (
    ...
    <div className="code-landing">
      ...
      <header className="code-landing-head">
        <div className="code-landing-topbar">
          <Link href="/dev" className="code-landing-back">
            ← /dev
          </Link>
        </div>
        ...
        <div className="code-landing-meta">
          ...
          <span className="code-landing-meta-dot">•</span>
          <Link href="/dev/architecture" className="code-landing-meta-link">
      ...
      <Link href="/dev/language/compare" className="code-landing-banner">
      ...
      <Link href="/dev/language/scramble" className="code-landing-banner">
        <div className="code-landing-banner-glyph">⟲</div>
        <div className="code-landing-banner-body">
          <div className="code-landing-banner-tag">
            // {tr({ zh: '横向对比', en: 'Side-by-side'
