...
const PROJECTS: Project[] = [
  ...
  {
    href: 'https://dev.visualstudio.com',
        ...
        <main id="top">
          ...
          <section className="section" id="vs">
            <header className="sec-head">
              ...
              <p className="sec-desc"><L
                zh={<>JS 和 TS 不是两门语言，是<strong>同一门语言的两种姿态</strong>。JS 的灵活成就了 web，TS 的纪律支撑起企业级。这个站点的 <a href="/dev/ts">/dev/ts</a> 页是同一题目的另一面。</>}
                en={<>JS and TS aren't two languages — they're <strong>two postures of the same language</strong>. JS's flexibility built the web; TS's discipline carries the enterprise. This site's <a href="/dev/ts">/dev/ts</a> page is the other face of the same coin.</>}
              /></p>
            </header>
