...
export const CATALOG: ComponentEntry[] = [
  {
    ...
    category: 'more',
    zh: 'Square-1 检查、过程、导入、数位、奇偶游戏、组合练习与 PBL 的共享页面壳。',
    en: 'Shared page shell for Square-1 inspection, visualization, importing, count positions, parity game, shape training, and PBL.',
  },
  {
    name: 'Sq1ToolNav',
    import: "import Sq1ToolNav from '@/components/Sq1ToolNav';",
    category: 'more',
    zh: 'Square-1 公式、PBL、训练、分析、数位和现有绘图工具的共用真链接导航。',
    en: 'Shared link navigation for Square-1 algorithms, PBL, training, analysis, count positions, and the existing drawing tool.',
  },
  {
    name: 'Sq1PblWorkspace',
    import: "import Sq1PblWorkspace from '@/components/Sq1PblWorkspace';",
    category: 'more',
    zh: 'Square-1 PBL 文档与公式查找器的共享工作区。',
    en: 'Shared workspace for the Square-1 PBL reference and algorithm finder.',
  },
  {
    name: 'LazyVisible',
