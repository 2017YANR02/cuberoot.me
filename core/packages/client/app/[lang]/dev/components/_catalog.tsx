...
export const CATALOG: ComponentEntry[] = [
  ...
  },
  {
    ...
    category: 'input',
    zh: '日期单值输入。固定显示 yyyy-mm-dd,使用站内双语日历,非空时复用 ClearButton 清除。值始终是无时区的日历日期字符串。',
    en: 'Canonical date-only input. It always displays yyyy-mm-dd, uses the site-localized calendar, and reuses ClearButton when populated. Values remain timezone-free calendar-date strings.',
