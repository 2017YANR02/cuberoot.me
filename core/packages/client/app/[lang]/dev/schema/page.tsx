...
const MIGRATIONS: { n: number; slug: string; desc: Bi }[] = [
  ...
  { n: 140, slug: 'sq1_pbl', desc: { zh: '导入 Daniel 的完整可执行 SQ1 PBL 公式集，并保留分类、推荐状态与来源助记。', en: 'Import Daniel’s complete executable SQ1 PBL algorithm set while preserving categories, recommendations, and source mnemonics.' } },
