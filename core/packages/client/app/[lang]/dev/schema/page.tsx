...
const MIGRATIONS: { n: number; slug: string; desc: Bi }[] = [
  ...
  { n: 140, slug: 'sq1_pbl', desc: { zh: '数据迁移：把 Daniel 的 967 个可执行 SQ1 PBL 情况导入标准公式库，并保留原表分类与助记。', en: 'Data migration: import Daniel’s 967 executable SQ1 PBL cases into the standard algorithm library, preserving the source taxonomy and mnemonics.' } },
