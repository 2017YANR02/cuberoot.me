...
// /dev/tokens — single-source color-token reference for the whole site.
...
const STRATEGY: { mode: string; zh: string; en: string; pages: string }[] = [
  { mode: '双主题', zh: '走 :root token,跟随用户 light / dark 自动翻', en: 'Follows :root tokens, flips with the user’s light / dark choice', pages: '/alg · /timer · /recon · /mosaic' },
    ...
    <div className="tk">
      <header className="tk-head">
        <div className="tk-topbar">
          <Link href="/dev" className="tk-back">← /dev</Link>
        </div>
