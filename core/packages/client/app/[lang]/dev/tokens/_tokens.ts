// Token manifest for /dev/tokens. The light/dark values here mirror app/globals.css
// (:root for light, html[data-theme=dark] for dark). They are NOT re-derived at
// build time — instead tests/dev-tokens-drift.test.ts re-reads globals.css and
