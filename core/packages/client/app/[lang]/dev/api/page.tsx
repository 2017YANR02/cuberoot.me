...
const ENDPOINTS: Ep[] = [
  ...
  { d: 'timer', m: 'POST', p: '/v1/battle/rooms', g: 'public', zh: '建联机对战房间；单次返回 playerId + 私有 capability + 房间码', en: 'Create an online battle room; returns playerId, a private capability, and the room code once' },
  ...
  { d: 'timer', m: 'POST', p: '/v1/battle/rooms/:code/event', g: 'public', zh: '凭 X-Battle-Token 在交卷前改自己的项目，并 lazy 填该项目打乱', en: 'Change your event before submission with X-Battle-Token and lazily fill its scramble' },
  { d: 'timer', m: 'POST', p: '/v1/battle/rooms/:code/scramble', g: 'public', zh: '凭 X-Battle-Token set-if-absent 填自己当前项目的本轮打乱', en: 'Set-if-absent this round’s scramble for your current event with X-Battle-Token' },
  ...
  { d: 'timer', m: 'POST', p: '/v1/battle/rooms/:code/next', g: 'public', zh: '凭 X-Battle-Token 在在线玩家全部交卷后原子开下一轮并结算', en: 'Atomically advance and settle after every online player submits, using X-Battle-Token' },
  ...
  { d: 'timer', m: 'POST', p: '/v1/battle/rooms/:code/kick', g: 'public', zh: '房主凭 X-Battle-Token 移出玩家并撤销其视频凭证', en: 'Remove a player and revoke their video credential with the host’s X-Battle-Token' },
