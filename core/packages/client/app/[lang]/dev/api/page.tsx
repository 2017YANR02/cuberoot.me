...
const ENDPOINTS: Ep[] = [
  ...
  { d: 'music', m: 'GET', p: '/v1/music/tracks/:id/download', g: 'login', c: 'no-store', zh: '会员或管理员以 attachment 下载已发布音频', en: 'Download published audio as an attachment (members or admins)' },
  { d: 'music', m: 'HEAD', p: '/v1/music/tracks/:id/download', g: 'login', c: 'no-store', zh: '会员或管理员读取下载响应头', en: 'Read download response headers (members or admins)' },
  { d: 'music', m: 'GET', p: '/v1/music/static-tracks/:id/download', g: 'login', c: 'no-store', zh: '会员或管理员下载未下架的静态曲库音频', en: 'Download an available static-library track (members or admins)' },
  { d: 'music', m: 'HEAD', p: '/v1/music/static-tracks/:id/download', g: 'login', c: 'no-store', zh: '会员或管理员读取静态曲库下载响应头', en: 'Read static-library download headers (members or admins)' },
  ...
  { d: 'content', m: 'PUT', p: '/v1/nav/home-order', g: 'admin', zh: '重排首页或账号页卡片', en: 'Reorder homepage or account cards' },
