...
/* auth-doc-review
{"fingerprint": "c8d9167b6b42393d2de8e35fb14d99bab815daed1769fea557813e81e71816ae", "reason": "复核抖音网站扫码、小程序登录、绑定和解绑：两端分别取同主体 AlliedID 识别同一用户，历史小程序身份在再次登录后补齐跨应用别名；不同账号持有相同标识时拒绝合并，解绑抖音时清除全部别名。六位绑定码仍限制尝试次数。并核对最新 App.tsx 变动仅涉及桌面智能魔方设备扫描，不改变安装版登录流程；微信及其他登录方式不变。"}
*/
