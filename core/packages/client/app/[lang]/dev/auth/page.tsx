...
/* auth-doc-review
{"fingerprint": "45bfbdff8da5d3614089a3e4c3f0d155d6c6297d780b8f4fc828b47a2c2a3a03", "reason": "复核短信登录：仅将阿里云标准短信发送实现换为固定版本共享传输包，本站仍负责验证码生成、冷却、存储与核销，手机号登录及绑定流程不变；共享包返回的是供应商受理而非手机实际送达。抖音、微信及其他登录流程不变。"}
*/
