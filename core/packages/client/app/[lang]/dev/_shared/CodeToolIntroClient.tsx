...
// One shell, two sections: /dev/stack and /dev/llm share this intro renderer.
const SECTIONS = {
  stack: { base: '/dev/stack', meta: STACK_TOOLS_META, load: loadStackTool },
  llm: { base: '/dev/llm', meta: LLM_TOOLS_META, load: loadLlmTool },
} as const;
