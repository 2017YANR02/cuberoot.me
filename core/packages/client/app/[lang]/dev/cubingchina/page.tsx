...
const FUTURE_CARDS: FutureCard[] = [
  {
    ...
    zh: {
      ...
      body: (<>
        ...
        <p>这跟 <a href="/dev/language/php">PHP 自己的故事</a> 惊人地像: <strong>被唱衰的技术, 靠"够用 + 稳定 + 解决真问题"活成基础设施</strong>。它最大的变量不是技术, 而是 <em>bus factor</em>——一个平台的健康压在一个人的持续投入上。</p>
    ...
    en: {
      ...
      body: (<>
        ...
        <p>It rhymes with <a href="/dev/language/php">PHP's own story</a>: <strong>written-off tech that survives into infrastructure by being good-enough, stable, and solving a real problem</strong>. Its biggest variable isn't technical — it's <em>bus factor</em>: a platform's health resting on one person's continued effort.</p>
        <div className="bar-compare">
        ...
        <footer className="footer">
          <div className="footer-grid">
            ...
            <div className="footer-col">
              ...
              <ul>
                <li><a href="/dev/language/php"><L zh="PHP — 它的后端语言" en="PHP — its backend language" /></a></li>
                <li><a href="/dev/architecture"><L zh="cuberoot.me 自己怎么搭" en="How cuberoot.me is built" /></a></li>
