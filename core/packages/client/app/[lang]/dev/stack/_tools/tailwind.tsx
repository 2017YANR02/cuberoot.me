...
export const TAILWIND: StackTool = {
  ...
  cuberoot: {
    zh: (
      <>
        <p>实话说:cuberoot.me 装了 Tailwind v4, 但<strong>几乎没在 JSX 里写 utility class</strong>。本站通过 Next/Turbopack 读取 <code>postcss.config.mjs</code> 里的 <code>@tailwindcss/postcss</code>, <code>app/globals.css</code> 顶部再用 <code>@import "tailwindcss"</code> 引入。</p>
    ...
    en: (
      <>
        <p>Straight up: cuberoot.me has Tailwind v4 installed, but <strong>almost no utility classes are written in the JSX</strong>. Next/Turbopack loads <code>@tailwindcss/postcss</code> from <code>postcss.config.mjs</code>, while <code>app/globals.css</code> imports <code>tailwindcss</code> at the top.</p>
