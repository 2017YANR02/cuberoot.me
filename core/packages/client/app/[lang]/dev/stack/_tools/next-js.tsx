  ...
  cuberoot: {
    ...
    en: (
      <>
        ...
        <p>Edge bits: <code>optimizePackageImports</code> per-symbol tree-shakes three / maplibre-gl / katex; <code>transpilePackages</code> picks up mp4box; because Turbopack does not emit a worker-runtime-independent cubing.js search worker, one shared build-time script generates the static asset for Web and all five installed hosts. Dozens of <code>redirects</code> (308) cover legacy URL renames, including the <code>/dev/ts</code> → <code>/dev/language/ts</code> batch.</p>
      </>
    ),
  },
  links: [
