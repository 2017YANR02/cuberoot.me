...
// Port of roux-trainers src/components/CubeSim2D.tsx (faithful; only the Defs
// import path changed to the ported engine). Pure 2D-canvas cube renderer used
// by the CMLL trainer's 2D / flat-3D case visualizer. No external deps.
import React, { useEffect } from 'react';

import { Face, FaceletCubeT } from '@/lib/roux/Defs';
