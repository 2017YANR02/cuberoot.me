...
export function homeRight(): HandPose {
  return {
    ...
    fingers: fingerPose(
      ...
      fc(0.87, 1.46, 0.41, 0.16),   // 拇指:近节折在掌根后,末节沿 F 面压 FR 棱外端
      fc(0.81, 1.49, 0.16, -0.13),  // 食指:高拱,指尖骑压 BUR 角后棱沿
      fc(0.78, 1.48, 0.24, -0.14),  // 中指:高拱压 BR 棱 B 面
      fc(0.79, 1.47, 0.27, -0.18),  // 无名指:钩压 BDR 角后棱沿
