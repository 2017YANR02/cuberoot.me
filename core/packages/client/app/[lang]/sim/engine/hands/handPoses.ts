...
function manoHomeRight(): HandPose {
  ...
  // 食指 tip z −123 悬空越面)。终解 tip x 42.6/36.1/46.0 ✓,但质量欠账:
  // pen −0.54、食指贴面 2.06、甲 0.917 —— r6(拇指尖抬回 y≈0 新规格)一并还。
  return {
    pos: new THREE.Vector3(321.37, -57.8, -94.47),
    quat: new THREE.Quaternion(-0.427516, -0.115281, 0.880609, 0.168719),
    fingers: fingerPose(
      { curl: [1.4975, -0.3642, 0.0065], splay: 0.4075, twist: 2.273, mid: [-0.309, -0.2864] }, // 拇指:水平 1.1°
      { curl: [0.6823, 0.5727, -0.0635], splay: -0.1172, twist: -0.0878 },  // 食指:tip x 42.6
      { curl: [0.9249, 0.3768, 0.403], splay: -0.0869, twist: 0.009 },      // 中指:tip x 36.1
      { curl: [0.8591, 0.5049, 0.1609], splay: 0.0344, twist: -0.1632 },    // 无名指:tip x 46.0
      { curl: [1.1863, 0.2079, 0.4055], splay: 0.5352, twist: 0.1362 },     // 小指:25° 蜷收豁免
    ),
  };
}
