...
function manoHomeRight(): HandPose {
  ...
  return {
    ...
    fingers: fingerPose(
      { curl: [1.0646, -0.4952, 0.0796], splay: 0.4628, twist: 2.3394, mid: [-0.7962, -0.0834] }, // 拇指:水平 0.7°,贴 F @Je
      { curl: [0.4462, 0.989, 0.1753], splay: -0.0774, twist: -0.1129 },   // 食指:tip x 86.9 @Q,gap 3.55
      { curl: [0.7424, 0.7351, 0.4091], splay: 0.1029, twist: -0.0248 },   // 中指:tip x 71.4 @Te,gap 2.89
      { curl: [0.6941, 0.8026, 0.138], splay: 0.1611, twist: -0.1206 },    // 无名指:tip x 78.1 @T,gap 2.36
      { curl: [1.0447, 0.3912, 0.2697], splay: 0.5106, twist: 0.0165 },    // 小指:∅ 悬空
    ),
  };
}
