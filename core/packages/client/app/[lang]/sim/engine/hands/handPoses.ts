...
function manoHomeRight(): HandPose {
  ...
  // 几何,解必须带着它收敛。终解:净距 1.11、倾角 3.6/2.0/6.4°、贴面
  // 2.91/2.90/2.91、pen −1.25、CMC −30.0、nail·ẑ 0.995、fGap 2.61。
  return {
    pos: new THREE.Vector3(321.69, -57.68, 8.94),
    quat: new THREE.Quaternion(-0.601784, -0.131452, 0.769801, 0.167278),
    fingers: fingerPose(
      { curl: [1.6178, -0.1948, -0.0401], splay: 0.3862, twist: 2.3015, mid: [-0.2911, -0.8531] }, // 拇指:CMC −30 沉 D + 甲面∥F 0.995
      { curl: [0.7508, 0.4935, -0.0187], splay: -0.297, twist: -0.2586 },  // 食指:3.6° 水平
      { curl: [0.9028, 0.4396, 0.3326], splay: -0.1287, twist: -0.1556 },  // 中指:2.0° 水平
      { curl: [0.7611, 0.5679, 0.3896], splay: -0.0883, twist: -0.3388 },  // 无名指:6.4° 水平
      { curl: [0.6303, 0.1327, 0.2808], splay: 0.3482, twist: -0.0935 },   // 小指:16.8° 蜷收,离无名指 1.11U
    ),
  };
}
