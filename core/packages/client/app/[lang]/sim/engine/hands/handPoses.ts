...
function manoHomeRight(): HandPose {
  ...
  return {
    ...
    fingers: fingerPose(
      { curl: [1.0646, -0.4952, 0.0796], splay: 0.4628, twist: 2.3394, mid: [-0.7962, -0.0834] }, // 拇指:水平 0.7°,贴 F @Je(r24 冻结未动)
      { curl: [0.6165, 0.7663, 0.113], splay: -0.1303, twist: -0.0511 },   // 食指:tip x 66.6 @Q,gap 1.26
      { curl: [0.7689, 0.6942, 0.344], splay: 0.212, twist: 0.1007 },      // 中指:tip x 66.0 @Te,gap 4.20
      { curl: [0.7801, 0.6848, 0.1092], splay: 0.1348, twist: -0.1046 },   // 无名指:tip x 69.4 @T,gap 2.67
      { curl: [1.081, 0.3112, 0.2697], splay: 0.4744, twist: 0.0245 },     // 小指:∅ 悬空
    ),
  };
}
