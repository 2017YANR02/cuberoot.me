...
const Cube2Solver = dynamic(() => import('./_Cube2Solver'), { ssr: false, loading: Loading });
...
const CticoSolver = dynamic(() => import('./_CticoSolver'), { ssr: false, loading: Loading });
...
function SolverDispatch() {
  ...
  if (event === 'ctico') return <CticoSolver />;
