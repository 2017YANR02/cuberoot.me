 ...
 * " / " 即止,只解前半段刚体打乱。
 */
import { randomCuboid337Scramble, solveCuboid337, CUBOID337_STATE_COUNT_STR, CUBOID337_ORBIT_PRODUCT_STR, type Cuboid337Solution } from '@cuberoot/puzzle-solvers/cuboid337';
...
const SPEC: SolverSpec<Cuboid337Solution> = {
  event: '337',
  titleZh: '3×3×7 求解器',
  titleEn: '3×3×7 Solver',
  previewSize: 64,
  invocation: { async: false, solve: solveCuboid337 },
  leadText: {
  ...
  errorNotationText: { zh: '打乱记号无法识别(应为 U U’ U2 u u’ u2 d d’ d2 D D’ D2 R2 L2 F2 B2)', en: 'Unrecognized notation (expected U U’ U2 u u’ u2 d d’ d2 D D’ D2 R2 L2 F2 B2)' },
