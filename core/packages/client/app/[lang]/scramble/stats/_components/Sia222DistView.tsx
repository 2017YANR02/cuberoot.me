    ...
    <>
      <div className="scramble-stats-controls">
        <div className="scramble-stats-puzzle-meta">
          <span>
            {tr({
              zh: '随机打乱样本(离线预计算,按 z2 y 拆半 + 各半 IDA* 最优,拼接=全局最优)',
              en: 'random-scramble samples (precomputed offline, split at z2 y + per-half optimal IDA*, concatenation is globally optimal)',
            })}
          </span>
