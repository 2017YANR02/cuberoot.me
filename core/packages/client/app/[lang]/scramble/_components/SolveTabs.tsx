...
export type SolvePuzzle = '3x3' | '2x2x2' | 'pyraminx' | 'skewb' | 'sq1' | 'ivy' | '133' | '223' | '8p' | '15p' | 'sfl' | 'ufo' | 'cm2' | 'dmd' | 'gear' | 'mpyrso' | 'crz3a';
...
const PUZZLE_BY_EVENT: Record<string, SolvePuzzle> = {
  '333': '3x3', '222': '2x2x2', pyram: 'pyraminx', skewb: 'skewb', sq1: 'sq1', ivy: 'ivy', '133': '133', '223': '223', '8p': '8p', '15p': '15p', sfl: 'sfl', ufo: 'ufo', cm2: 'cm2', dmd: 'dmd', gear: 'gear', mpyrso: 'mpyrso', crz3a: 'crz3a',
};
...
const HAS_DISTRIBUTION: ReadonlySet<SolvePuzzle> = new Set(['3x3', '2x2x2', 'pyraminx', 'skewb', 'sq1', 'ivy', '133', '223', '8p', '15p', 'sfl', 'ufo', 'cm2', 'dmd', 'gear', 'mpyrso', 'crz3a']);
