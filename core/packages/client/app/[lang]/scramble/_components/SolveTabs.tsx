...
export type SolvePuzzle = '3x3' | '2x2x2' | 'pyraminx' | 'skewb' | 'sq1' | 'ivy' | '133' | '223' | '8p' | 'sfl' | 'ufo' | 'cm2';
...
const PUZZLE_BY_EVENT: Record<string, SolvePuzzle> = {
  '333': '3x3', '222': '2x2x2', pyram: 'pyraminx', skewb: 'skewb', sq1: 'sq1', ivy: 'ivy', '133': '133', '223': '223', '8p': '8p', sfl: 'sfl', ufo: 'ufo', cm2: 'cm2',
};
...
const HAS_DISTRIBUTION: ReadonlySet<SolvePuzzle> = new Set(['3x3', '2x2x2', 'pyraminx', 'skewb', 'sq1', 'ivy', '133', '223', '8p', 'sfl', 'ufo', 'cm2']);
