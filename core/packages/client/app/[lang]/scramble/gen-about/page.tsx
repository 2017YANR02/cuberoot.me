    ...
    <div className="ga-page">
      ...
      <main className="ga-main">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  {' '}
                  <Link href="/scramble/555-about">{t('详情', 'details')}</Link>
                </td>
              </tr>
              <tr>
                <td>6×6 / 7×7</td>
        ...
        <ul className="ga-refs">
          <li>
            <Link href="/scramble/555-about">{t('5×5 打乱方法对照', '5×5 scramble methods')}</Link>
            {t(' — 随机转动 vs 随机状态,以及 cube555 daemon 的 5 个 phase 怎么跑。', " — random-move vs random-state, plus the 5 phases of the cube555 daemon.")}
          </li>
          <li>
            <Link href="/scramble/analyzer">{t('CFOP 打乱分析器', 'CFOP scramble analyzer')}</Link>
