  ...
  return (
    <div className="cala-page">
      <div className="cala-header">
        <Link to="/wca/calendar" className="cala-back">
          <ArrowLeft size={16} />
      ...
      <main className="cala-main">
        ...
        <ul className="cala-refs">
          <li>
            <Link to="/wca/comp">{t('比赛成绩查看', 'Competition Results')}</Link>
            {t(' — 逐轮次 cubing.com 实时成绩。', ' — round-by-round live results from cubing.com.')}
          </li>
          <li>
            <Link to="/wca/globe">{t('地球视图', 'Globe')}</Link>
            {t(' — 比赛地理分布地图。', ' — competition locations on a 3D globe.')}
          </li>
          <li>
            <Link to="/wca/calendar/stats">{t('比赛统计', 'Calendar Stats')}</Link>
