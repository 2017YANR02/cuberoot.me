...
import { k, v, s, f, p, c } from '../stack_tool_types';
...
export const PNPM: StackTool = {
  ...
  cuberoot: {
    zh: (
      <>
        <p>本仓库根是一个静态 HTML 集合 (来自多个 fork), 真正的开发都在 <code>core/</code> 里。<code>core/</code> 是 pnpm workspace 根, <code>pnpm-workspace.yaml</code> 声明 <code>packages/*</code> 全部纳入。当前有 11 个 workspace:<code>@cuberoot/client</code> (主 SPA)、<code>@cuberoot/server</code> (Hono + PG API)、<code>@cuberoot/shared</code> (共享类型)、<code>@cuberoot/stats-build</code> (WCA 统计管道)、<code>@cuberoot/stats-ui</code>、<code>@cuberoot/alg-build</code>、<code>@cuberoot/scramble-stats-build</code>、<code>@cuberoot/stack-kernel</code>、<code>@cuberoot/vendor-sr-puzzlegen</code>、<code>@cuberoot/visualcube</code>、<code>@cuberoot/wb-build</code>。</p>
    ...
    en: (
      <>
        <p>The repo root is a collection of static HTML (from various forks); all real development lives under <code>core/</code>. <code>core/</code> is the pnpm workspace root — <code>pnpm-workspace.yaml</code> declares <code>packages/*</code> as members. There are 11 workspaces today: <code>@cuberoot/client</code> (the main SPA), <code>@cuberoot/server</code> (Hono + PG API), <code>@cuberoot/shared</code> (shared types), <code>@cuberoot/stats-build</code> (WCA stats pipeline), <code>@cuberoot/stats-ui</code>, <code>@cuberoot/alg-build</code>, <code>@cuberoot/scramble-stats-build</code>, <code>@cuberoot/stack-kernel</code>, <code>@cuberoot/vendor-sr-puzzlegen</code>, <code>@cuberoot/visualcube</code>, <code>@cuberoot/wb-build</code>.</p>
