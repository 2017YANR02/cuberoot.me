    ...
    <div className="stack-landing">
      ...
      <header className="stack-landing-head">
        ...
        <p className="stack-landing-sub">
          {lang === 'zh'
            ? '不是"流行清单",是 cuberoot.me 真正用过的 28 件软件 —— 在生产 VM 上跑的,加上写它的工具链。一件一篇,讲来历、讲长处、讲它在这套架构里干什么活。'
            : 'Not a "trending list" — the 28 actual pieces of software cuberoot.me leans on: what runs on the production VM, plus the authoring chain that writes it. One page each: history, strengths, and the exact job it does in this architecture.'}
        </p>
