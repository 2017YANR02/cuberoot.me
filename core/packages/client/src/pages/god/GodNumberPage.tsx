...
const MILESTONES: Milestone[] = [
  ...
  { year: 2024, zh: <>Merino & Subercaseaux (arXiv:2501.00144) 提出"Demigod's number" —— 用 500k 随机样本 + Hoeffding 在 5 小时内证 <TeX src="D \le 36" />,误证概率 <TeX src="< 10^{-10}" />。详见 <Link to="/math/demigod" style={{ color: 'var(--accent)', textDecoration: 'none', borderBottom: '1px dotted currentColor' }}>专门页面</Link>。</>, en: <>Merino & Subercaseaux (arXiv:2501.00144) propose a "Demigod's number" — 500k random samples + Hoeffding prove <TeX src="D \le 36" /> in 5 hours, error probability <TeX src="< 10^{-10}" />. <Link to="/math/demigod" style={{ color: 'var(--accent)', textDecoration: 'none', borderBottom: '1px dotted currentColor' }}>Dedicated page</Link>.</> },
