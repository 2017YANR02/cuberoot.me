...
import { PAPER_MEAN, PAPER_TOTAL } from './DistanceHistogram';
import './demigod.css';

const HoeffdingExplorer = lazy(() => import('./HoeffdingExplorer'));
const DistanceHistogram = lazy(() => import('./DistanceHistogram'));
const VertexTransitiveProof = lazy(() => import('./VertexTransitiveProof'));
const LiveSampler = lazy(() => import('./LiveSampler'));
  ...
  return (
    <div className="demigod-page">
      <header className="dg-header">
        <Link to="/math/god" className="dg-back">
          <ArrowLeft size={16} />
      ...
      <main className="dg-main">
        ...
        <section className="dg-section">
          ...
          <ol className="dg-refs">
            ...
            <li data-i="12"><Link to="/math/god">/math/god</Link> — {t('回到全 WCA 项目的上帝之数总览', "back to the all-WCA-events God's number overview")}</li>
          </ol>
        </section>
