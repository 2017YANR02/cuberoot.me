  ...
  return (
    <div className="calca-page">
      <div className="calca-header">
        <Link to="/calc" className="calca-back">
          <ArrowLeft size={16} />
