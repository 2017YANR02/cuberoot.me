 ...
 *
 * Ported to ES module for /alg/commutator. IIFE wrapper stripped — function/const
 * declarations now live at module top-level. Behavior unchanged from upstream.
 */
...
export { search, expand, commutatorPost };
export const commutator = { search, expand, commutatorPost };
