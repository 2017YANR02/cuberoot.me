...
export const laptop = rect(-90, -80, 180, 109, ink, 12) + rect(-82, -72, 164, 83, blue, 6) + line('M-61-48H-20M-61-27H37', cream, 7) + p('M-90 29H90L113 47H-113Z', cream) + rect(-26, 29, 52, 9, ink, 2);
export const book = p('M0-26Q-50-53-89-23V57Q-47 33 0 57 46 34 89 57V-23Q45-50 0-26Z', cream) + p('M0-20Q-47-42-79-20V43Q-43 25 0 47Z', blue) + line('M0-21V49', ink, 4) + line('M17-10 64-9M17 6 65 8M17 24 60 28', blue, 4);
