 ...
 *
 *   $env:GEN_PG_FACTS='1'; pnpm --filter @cuberoot/client exec vitest run tests/gen_pg_facts.gen.test.ts
 *
...
const OUT = resolve(
  ...
  '../app/[lang]/sim/engine/pgFacts.generated.ts',
);
...
// Regenerate (PowerShell): $env:GEN_PG_FACTS='1'; pnpm --filter @cuberoot/client exec vitest run tests/gen_pg_facts.gen.test.ts
