...
it('treats the tunnel and loopback as development environments', () => {
  for (const host of ['localhost', '127.0.0.1', '[::1]', 'dev.cuberoot.me', 'dev-mac-mini.cuberoot.me', 'dev-ruimin-mac-mini.cuberoot.me', 'dev-alienware.cuberoot.me', 'dev-ruimin-alienware.cuberoot.me', 'dev-macbook-pro.cuberoot.me', 'dev-ruimin-macbook-pro.cuberoot.me']) {
