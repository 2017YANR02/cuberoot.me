...
export interface BoolToggleProps {
  /** Website adapter preserves its existing switch styling. */
  renderSwitch?: (props: { value: boolean; onChange: (value: boolean) => void; disabled?: boolean; ariaLabel: string }) => ReactNode;
  value: boolean;
