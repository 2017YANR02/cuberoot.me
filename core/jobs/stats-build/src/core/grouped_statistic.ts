...
import { Statistic, type StatJson, type RecordScope } from './statistic.js';
import { headerZh, eventZh } from './events.js';
import type { RowDataPacket } from 'mysql2';

export type GroupedSection = [string, unknown[][], RecordScope?];
...
export abstract class GroupedStatistic extends Statistic {
  ...
  abstract override transform(rows: RowDataPacket[]): GroupedSection[];
