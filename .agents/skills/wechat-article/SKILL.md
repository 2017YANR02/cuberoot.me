...
7. If the user names an exact source image, never pass it through image generation or crop, resize, redraw, recolor, retouch, or warp it; composite the original pixels deterministically and verify the source hash is unchanged.
