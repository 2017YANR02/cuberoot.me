...
- 新增路由或修改标题、SEO metadata 前必须读 [SEO 契约](references/seo-metadata.md)(路径相对仓库根目录);静态路由维护 `core/packages/client/lib/page-meta.ts` 与路由 server `layout.tsx`,动态参数按该节的可枚举/哨兵规则处理。
